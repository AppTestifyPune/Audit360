...
public class RedistributionScoringLogicScenario7AndSurpriseAuditTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Score Logic Scenario 7 And Surprise Audit Test", "Testing the Functionality of the Redistribution Score Logic NA distrubution based on score contribution with Partia");

		chiledTest = parentTest.createNode("Creating Group Test");

		System.out.println("Creating Group Test");

		System.out.println("***Redistribution Score Logic Scenario 7 Test***");
		...
		String ADG = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 22, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 17, 0);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 17, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 32, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 17, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 31, 0);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 18, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 17, 0);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 24, 0);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 29, 0);
		CC.SetYestextBox(YB8);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 4, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 80, 0);
		...
		CA.ClickSubjectiveRadioBTN();

		//verifying Scoring and Rating can be simulated by the reviewer, before finalization. Not recommended, as this can lead to subjectivity. To be used with sufficient caution. is Displayed
		CA.VerifySubjectivePopUpIsDisplayed();

		//clicking on the OK button
		CA.ClickSubjectivePopUpOKBTN();

		//checking Surprise Audit radio button is Enabled or not
		CA.VerifySupriseAuditRadioButtonIsEnabldByDefult();

		//clicking on the Surprise Audit radio button
		CA.ClickSurpriseAuditRadioButton();
		...
		String FT = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
	...
	public void Super_Admin_Adding_Refernce_Files_Test() throws InterruptedException
	{
		AuditSchedulePageTest SP = new AuditSchedulePageTest(driver);

		EditSchedulePageTest ES = new EditSchedulePageTest(driver);

		LoginPageTest l=new LoginPageTest(driver);

		chiledTest = parentTest.createNode("Super Admin Adding Reference Files Test");

		System.out.println("Super Admin Adding Reference Files Test");

		//clicking on the header
		SP.ClickAuditScheduleHeader();

		//passing the values to select Audit Type
		String SAT = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		...
		System.out.println("****Attaching Mp4 File****");

		chiledTest.log(Status.INFO, "****Attaching Mp4 File****");

		//clicking on the attach audit Reference button
		ES.ClickAttachAuditReferenceButton(driver);

		//clicking on the confidential radio button
		ES.ClickConfidentialRadioBTNRadioButton();

		//Uploading Invalid Type Documents
		ES.UploadingMP4FileType();

		//clicking on the submit button
		ES.ClickSubmitButton();

		//checking the Not a valid file: Audio/Video files are not permitted Error Message is Displayed
		ES.VerifyAudioVideoFilesAreNotPermittedErrorMSGISDisplayed();

		//clicking on the Close Button
		ES.ClickCloseBTN(driver);

		driver.navigate().refresh();

		System.out.println("****Attaching Mp3 File****");

		chiledTest.log(Status.INFO, "****Attaching Mp3 File****");

		//passing the values to select Audit Type
		String SAT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		SP.SetSelectAuditTypeSearchFiled(SAT1);
		...
		System.out.println("****Attaching More Than 30 MB File****");

		chiledTest.log(Status.INFO, "****Attaching More Than 30 MB File****");

		//passing the values to select Audit Type
		String SAT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		SP.SetSelectAuditTypeSearchFiled(SAT2);
		...
		//Uploading More Than 25 MB file
		ES.UploadMoroThan25MBFileType();

		//clicking on the submit button
		ES.ClickSubmitButton();

		//checking the File size should be less than 25mb Error Message is Displayed
		ES.VerifyFileSizeShouldBeLessThan25MBErrorMSGISDisplayed();

		ES.ClickCloseBTN(driver);

		driver.navigate().refresh();

		System.out.println("****Attaching JPG File****");

		chiledTest.log(Status.INFO, "****Attaching JPG File****");

		//passing the values to select Audit Type
		String SAT3 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		...
		ES.UploadingJPGDocuments();

		//clicking on the submit button
		ES.ClickSubmitButton();

		//Verifying Document uploaded successfully Pop up is displayed
		ES.VerifyDocumentUploadedSuccessfullyPopUpIsDisplayed();

		driver.navigate().refresh();

		System.out.println("****Attaching CSV File****");

		chiledTest.log(Status.INFO, "****Attaching CSV File****");

		//passing the values to select Audit Type
		String SAT4 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		SP.SetSelectAuditTypeSearchFiled(SAT4);
	...
	@Test(priority=8, dependsOnMethods= {"Super_Admin_Adding_Refernce_Files_Test"})
	public void Making_Schedule_InProgress_Test() throws InterruptedException
	{
		LoginPageTest l=new LoginPageTest(driver);

		AuditExecutionPageTest AE = new AuditExecutionPageTest(driver);

		chiledTest = parentTest.createNode("Making Schedule In Progress Test");

		System.out.println("Making Schedule In Progress Test");
		...
		String AT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
	...
	//Testing the Functionality of the Auditee User should see the Not Started status schedule and attach the doc
	@Test(priority=9, dependsOnMethods= {"Making_Schedule_InProgress_Test"})
	public void Adding_The_Documents_By_Auditee_User_Test() throws InterruptedException
	{
		...
		chiledTest = parentTest.createNode("Adding the Documents By Auditee user Test");

		System.out.println("Adding the Documents By Auditee user Test");
		...
		MA.ClickAttachAuditReferenceButton();
		...
		System.out.println("****Attaching More Than 25 MB File****");

		chiledTest.log(Status.INFO, "****Attaching More Than 25 MB File****");
		...
		chiledTest.log(Status.INFO, "****Attaching PDF  File****");

		//clicking on the Attach Button
		MA.ClickAttachAuditReferenceButton();

		//Uploading PDF Type Documents
		ES.UploadingPDFFileType();

		//clicking on the submit button
		ES.ClickSubmitButton();

		//Verifying Document uploaded successfully Pop up is displayed
		MA.VerifyDocumentUploadedSuccessfullyMSGIsDisplayed();
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=10, dependsOnMethods= {"Adding_The_Documents_By_Auditee_User_Test"})
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		//**********Attach Audit Reference File Test***********
		...
		System.out.println("*****Attaching More Than 25MB File ****");

		chiledTest.log(Status.INFO, "*****Attaching More Than 25MB File******");
		...
		ES.UploadingJPGDocuments1();

		//clicking on the submit button
		ES.ClickSubmitButton();

		//Verifying Document uploaded successfully Pop up is displayed
		AE.VerifyDocumentUploadedSuccessfullyMSGIsDisplayed();
		...
		//Passing the General Parent Audit type to Audit Type
		String AT4 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		AE.SetAuditType(AT4, driver);
		chiledTest.log(Status.INFO, "Audit Type is Searched");
		...
		//Passing the General Parent Audit type to Audit Type
		String AT5 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		AE.SetAuditType(AT5, driver);
		...
		String MV = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 102, 0);
		...
		//Passing the Values to Max values
		String MV1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 102, 0);
		...
		//Passing the Values to Enter Input Values
		String IV1 = Lib.getCellValue(XLPATH, "Audit Execution", 41, 0);
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=11, dependsOnMethods= {"Audit_Execution_Tets"})
	public void Simulate_Score_Test() throws InterruptedException
	{
		chiledTest = parentTest.createNode("Simulate Score Test");

		System.out.println("Simulate Score Test");
		...
		String SB = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 9, 0);
		...
		String Expected_TotalScore = "144.31 / 155.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 92, 0);
		...
		String Expected_Compliances = "93.1";
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=12, dependsOnMethods= {"Simulate_Score_Test"})
	public void Updating_Complaince_Test() throws Exception
	{
		chiledTest = parentTest.createNode("Updating Complaince Test");

		System.out.println("Updating Complaince Test");
		...
		System.out.println("*****************Updating the Compliance for 1st Group**********************");

		chiledTest.log(Status.INFO, "**************Updating the Compliance for 1st Group******************");

		//Removing the Already Selected Group from the Select Group
		RA.ClickRemoveBTN();

		//Passing the 1st group
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		System.out.println("*********** 1st CP ************");

		chiledTest.log(Status.INFO, "************ 1st CP *************");

		//clicking on the 1st CP
		...
		//Passing the Value to Compliance
		String SC = Lib.getCellValue(XLPATH, "Review Audit", 70, 0);
		RC.SetCompliance(SC);
		chiledTest.log(Status.INFO, "No Compliance is Selected");

		RC.ClickMatched();

		//selecting all Dispositions
		RC.SelectAllDispositions();

		//clicking on the Update Button
		RC.ClickUpdateButton();
		...
		//Passing the Value to Compliance
		String SC1 = Lib.getCellValue(XLPATH, "Review Audit", 69, 0);
		RC.SetCompliance(SC1);
		chiledTest.log(Status.INFO, "Yes Compliance is Selected");
		...
		//Passing the Value to Compliance
		String SC2 = Lib.getCellValue(XLPATH, "Review Audit", 72, 0);
		RC.SetCompliance(SC2);
		chiledTest.log(Status.INFO, "NA Compliance is Selected");
		...
		System.out.println("***********4th CP ************");

		chiledTest.log(Status.INFO, "************4th CP *************");

		//clicking on the 4th CP
		...
		//Passing the Value to Compliance
		String SC3 = Lib.getCellValue(XLPATH, "Review Audit", 72, 0);
		RC.SetCompliance(SC3);
		chiledTest.log(Status.INFO, "NA Compliance is Selected");
		...
		System.out.println("*****************Updating the Compliance for 2nd Group**********************");

		chiledTest.log(Status.INFO, "**************Updating the Compliance for 2nd Group******************");

		//Removing the Already Selected Group from the Select Group
		RA.ClickRemoveBTN();

		//Passing the 1st group
		String SA1 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 4, 0);
		RA.SetGroup(SA1);

		RA.ClickMatchedTextOption(driver);

		System.out.println("***********5th CP ************");

		chiledTest.log(Status.INFO, "************5th CP *************");
		...
		//Passing the Value to Compliance
		String SC5 = Lib.getCellValue(XLPATH, "Review Audit", 70, 0);
		RC.SetCompliance(SC5);
		chiledTest.log(Status.INFO, "NO Compliance is Selected");
		...
		System.out.println("***********6th CP ************");

		chiledTest.log(Status.INFO, "************6th CP *************");

		//clicking on the 6th CP
		...
		//Passing the Value to Compliance
		String SC6 = Lib.getCellValue(XLPATH, "Review Audit", 69, 0);
		RC.SetCompliance(SC6);
		chiledTest.log(Status.INFO, "Yes Compliance is Selected");
		...
		System.out.println("***********7th CP ************");

		chiledTest.log(Status.INFO, "************7th CP *************");

		//clicking on the 7th CP
		...
		//Passing the Value to Compliance
		String SC7 = Lib.getCellValue(XLPATH, "Review Audit", 72, 0);
		RC.SetCompliance(SC7);
		chiledTest.log(Status.INFO, "NA Compliance is Selected");
		...
		System.out.println("***********8th CP ************");

		chiledTest.log(Status.INFO, "************8th CP *************");

		//clicking on the 8th CP
		...
		//Passing the Value to Compliance
		String SC8 = Lib.getCellValue(XLPATH, "Review Audit", 70, 0);
		RC.SetCompliance(SC8);
		chiledTest.log(Status.INFO, "NO Compliance is Selected");
		...
		//clicking on the simulate score
		RA.ClickSimulateScoreBTN();
		...
		String Actual_TotalScore = driver.findElement(By.xpath("//div[@class='recalc_total_score']")).getText();
		System.out.println("Actual Total Score is : " + Actual_TotalScore);
		String Expected_TotalScore = "35.69 / 155.0";
		System.out.println("Expected Total Score is : " + Expected_TotalScore);
		Assert.assertEquals(Actual_TotalScore, Expected_TotalScore, "Total Score is Wrong");
		chiledTest.log(Status.INFO, "Expected and Actual Total score are Matched");
		...
		String Actual_Compliances = driver.findElement(By.xpath("//div[@class='recalc_compliance_percentage']")).getText();
		System.out.println("Actual Rating is : " + Actual_Compliances);
		String Expected_Compliances = "91.8";
		System.out.println("Expected Compliance is : " + Expected_Compliances);
		Assert.assertEquals(Actual_Compliances, Expected_Compliances, "Compliances % is Wrong");
		chiledTest.log(Status.INFO, "Expected and Actual Compliances % are Matched");
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=13, dependsOnMethods= {"Updating_Complaince_Test"})
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=14, dependsOnMethods= {"Finalizing_The_AuditType_Test"})
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		String Expected_Disposition1 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		...
		String Expected_ComplianceScore1 = "No";
		...
		String Expected_SubmittedScore1 = "37.5";
		...
		String Expected_SubmittedScore4 = "6.25";
		...
		String Expected_FinalScore4 = "0.0";
		...
		String SA2 = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_SubmittedScore5 = "71.11";
		...
		//checking the Disposition
		String Actual_Disposition6 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[4]")).getText();
		String Expected_Disposition6 = Lib.getCellValue(XLPATH, "Check Point", 169, 0);
		System.out.println("Actual Disposition is : " + Actual_Disposition6);
		System.out.println("Expected Disposition is : " + Expected_Disposition6);
		Assert.assertEquals(Actual_Disposition6, Expected_Disposition6, "Disposition is Wrong");
		System.out.println("Disposition is Matched");
		...
		String Expected_Disposition8 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		...
		String Expected_ComplianceScore8 = "No";
		...
		String Expected_SubmittedScore8 = "4.44";
		...
		String Actual_AuditRating = driver.findElement(By.xpath("//div[@class='recalc_rating']")).getText();
		System.out.println("Actual Rating is : " + Actual_AuditRating);
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RSL Scenarios 7", 94, 0);
		System.out.println("Expected Rating is : " + Expected_AuditRating);
		Assert.assertEquals(Actual_AuditRating, Expected_AuditRating, "Audit Rating is Wrong");
		chiledTest.log(Status.INFO, "Expected and Actual ratings are Matched");
