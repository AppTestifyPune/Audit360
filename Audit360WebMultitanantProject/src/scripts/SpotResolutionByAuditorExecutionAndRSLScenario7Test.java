...
public class SpotResolutionByAuditorExecutionAndRSLScenario7Test extends BaseTest{
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Spot Resolution By Auditor Execution And RSL Scenario7 Functionality Test", "Testing the Functionality of the Redistribution Score Logic NA distrubution based on score contribution with Partia");

		System.out.println("***Spot Resolution By Auditor Execution And RSL Scenario7 Functionality Test**");
	   ...
	   /*//clicking on the Group Type
		...
		String ADG = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 22, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 17, 0);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 17, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 32, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 17, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 31, 0);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 18, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 17, 0);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 24, 0);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 29, 0);
		CC.SetYestextBox(YB8);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 4, 0);
		...
		String LR = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 76, 0);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 67, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 80, 0);
		...
		String FT = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
		...
		String MV = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 102, 0);
		...
		//Passing the Values to Max values
		String MV1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 102, 0);
		...
		String SF = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 13, 0);
	...
	public void Signoff_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Check Point", 128, 0);
	...
	public void Spot_Closing_And_Finalizing_The_AuditType_Test() throws Exception
	{
		chiledTest = parentTest.createNode("Spot Closing And Finalize Audit Test");

		System.out.println("Spot Closing And Finalize Audit Test");
		...
		String SB = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 4, 0);
		RA.SetGroup(SA1);
		...
		chiledTest.log(Status.INFO, "**************Clsoing the Issue******************");
		...
		//checking Resolution is done success message is displayed
		...
		//Passing the Values to Search Text field
		String SB1 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 9, 0);
		...
		//Passing the 1st group
		String SA5 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 3, 0);
		RA.SetGroup(SA5);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA6 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 4, 0);
		RA.SetGroup(SA6);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=10, dependsOnMethods= {"Spot_Closing_And_Finalizing_The_AuditType_Test"})
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		String Expected_FinalScore1 = "37.5";
		...
		String Expected_Disposition2 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		...
		String Expected_FinalScore4 = "6.25";
		...
		String SA2 = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_FinalScore5 = "71.11";
		...
		String Expected_Disposition2111 = Lib.getCellValue(XLPATH, "Check Point", 169, 0);
		...
		String Expected_SubmittedScore8 = "6.67";
		...
		String Expected_FinalScore8 = "6.67";
		...
		String Expected_TotalScore = "146.53 / 155.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "Spot Normal RSL Scenarios 7", 92, 0);
		...
		String Expected_Compliances = "94.53";
