...
public class RedistributionScoringLogicScenario5AndparallelExecutionTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Score Logic Scenario 5 Test", "Testing the Functionality of the Redistribution Score Logic NA with all NO");

		chiledTest = parentTest.createNode("Creating Group Test");

		System.out.println("***Redistribution Score Logic Scenario 5 Test***");
		...
		String ADG = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 21, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 17, 0);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 21, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 21, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 17, 0);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 21, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 17, 0);
		CC.SetNoTextBox(NB8);
	...
	//Adding the 4 types of Checkpoints
	@Test(priority = 1182, dependsOnMethods= {"Adding_Four_CheckPoints_To_Group_Test"})
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 4, 0);
		CC.SetSearchBTN(SS);
	...
	@Test(priority=3, dependsOnMethods= {"Adding_Four_CheckPoints_To_another_Group_Test"})
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 4, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 80, 0);
		...
		String FT = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 92, 0);
	...
	@Test(priority=4, dependsOnMethods= {"Creating_Parent_Audit_Type_Test"})
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 9, 0);
	...
	public void Creating_parallel_Execution_Schedule_Test() throws InterruptedException
	{
		AuditSchedulePageTest SP = new AuditSchedulePageTest(driver);

		LoginPageTest l=new LoginPageTest(driver);

		chiledTest = parentTest.createNode("Creating parallel Execution Schedule Test");

		System.out.println("Creating parallel Execution Schedule Test");
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 9, 0);
		...
		SP.ClickParallelExecutionCheckBox();

		//Selecting Auditor
		String SA3 = Lib.getCellValue(XLPATH, "Schedule", 33, 0);
		SP.SetSetSelectAuditor(SA3);
		chiledTest.log(Status.INFO, "1st Auditor is Selected");

		//Clicking on the Matched 
		SP.ClickMatched();

		//Selecting Auditor
		String SA4 = Lib.getCellValue(XLPATH, "Schedule", 34, 0);
		SP.SetSetSelectAuditor(SA4);
		chiledTest.log(Status.INFO, "2nd Auditor is Selected");
	...
	@Test(priority=6, dependsOnMethods= {"Creating_parallel_Execution_Schedule_Test"})
	public void Executing_The_Schedule_By_1st_Auditor_Through_Normal_Mode_Test() throws InterruptedException
	{
		LoginPageTest l=new LoginPageTest(driver);

		AuditExecutionPageTest AE = new AuditExecutionPageTest(driver);

		chiledTest = parentTest.createNode("Executing The Schedule By 1st Auditor Through Normal Mode Test");

		System.out.println("Executing The Schedule By 1st Auditor Through Normal Mode Test Test");
		...
		String AT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 9, 0);
		AE.SetAuditType(AT2, driver);
		chiledTest.log(Status.INFO, "Audit Type is Searched");

		AE.ClickMatched();

		//Checking the Reject Reassign and Edit button should not be display
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 9, 0);
		...
		String MV = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		...
		//Passing the Values to Max values
		String MV1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		...
		//Job Done Button is Clicked
		AE.ClickJobDoneButton();

		//Verifying Job Done success message is displayed
		AE.VerifyJobDoneSuccessfullyMSGIsDisplayed();
		...
		//Passing the Values to Max values
		String MV3 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=7, dependsOnMethods= {"Executing_The_Schedule_By_1st_Auditor_Through_Normal_Mode_Test"})
	public void Executing_The_Schedule_By_2nd_Auditor_Through_Express_Mode_Test() throws InterruptedException
	{
		...
		//Checking Only 5 checkpoint should Display
		List<WebElement> TotalCPCount = driver.findElements(By.xpath("//ul[@id='sortable1']/li"));
		int Actual_TotalCPCount = TotalCPCount.size();
		int Expected_TotalCPCount = 5;
		Assert.assertEquals(Actual_TotalCPCount, Expected_TotalCPCount, "Checkpoints count is Wrong");
		System.out.println("5 Checkpoints are Displayed");
		chiledTest.log(Status.INFO, "5 Checkpoints are Displayed");
		...
		WebElement Partail = driver.findElement(By.xpath("//ul[@id='sortable3']"));
		wait.until(ExpectedConditions.visibilityOf(Partail));
		action.dragAndDrop(CP1, Partail).build(). perform();
		System.out.println("First Checkpoint is Dragged to Partail");
		chiledTest.log(Status.INFO, "First Checkpoint is Dragged to Partail");
		...
		WebElement Partail2 = driver.findElement(By.xpath("//ul[@id='sortable3']"));
		wait.until(ExpectedConditions.visibilityOf(Partail2));
		action.dragAndDrop(CP2, Partail2).build(). perform();
		System.out.println("2nd Checkpoint is Dragged to Partail");
		chiledTest.log(Status.INFO, "2nd Checkpoint is Dragged to Partail");
		...
		WebElement Partail3 = driver.findElement(By.xpath("//ul[@id='sortable3']"));
		wait.until(ExpectedConditions.visibilityOf(Partail3));
		action.dragAndDrop(CP3, Partail3).build(). perform();
		System.out.println("3rd Checkpoint is Dragged to Partail");
		chiledTest.log(Status.INFO, "3rd Checkpoint is Dragged to Partail");

		System.out.println("*****Dragging 4th checkpoint to NA Compliance********");

		chiledTest.log(Status.INFO, "*****Dragging 4th checkpoint to NA Compliance********");
		...
		action.dragAndDrop(CP4, NA).build(). perform();
		System.out.println("4th Checkpoint is Dragged to NA");
		chiledTest.log(Status.INFO, "4th Checkpoint is Dragged to NA");

		System.out.println("*****Dragging 5th checkpoint to Partial Compliance********");

		chiledTest.log(Status.INFO, "*****Dragging 5th checkpoint to Patial Compliance********");

		Thread.sleep(2000);

		WebElement CP5 = driver.findElement(By.xpath("//ul[@id='sortable1']/li[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(CP5));
		WebElement Partail4 = driver.findElement(By.xpath("//ul[@id='sortable3']"));
		wait.until(ExpectedConditions.visibilityOf(Partail4));
		action.dragAndDrop(CP5, Partail4).build(). perform();
		System.out.println("4th Checkpoint is Dragged to Partail");
		chiledTest.log(Status.INFO, "4th Checkpoint is Dragged to Partail");
		...
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 105, 0);
		AE.SetSecondSamplePassedValue(SO);
		chiledTest.log(Status.INFO, "50 is Enterd Under Smaple Passed");

		//Passing the Values to 2nd Sample Reviewed
		String SM = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		AE.SetSecondSampleReviewed(SM);
		chiledTest.log(Status.INFO, "100 is Enterd Under Smaple Reviewed");

		//Passing the Values to 3rd Sample Passed
		String TO = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 105, 0);
		AE.SetThirdSamplePassedValue(TO);
		chiledTest.log(Status.INFO, "50 is Enterd Under Smaple Passed");

		//Passing the Values to 3rd Sample Reviewed
		String TM = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		AE.SetThirdSampleReviewed(TM);
		chiledTest.log(Status.INFO, "100 is Enterd Under Smaple Reviewed");

		//Passing the Values to 4th Sample Passed
		String FS = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 105, 0);
		AE.SetFourthSamplePassedValue(FS);
		chiledTest.log(Status.INFO, "50 is Enterd Under Smaple Passed");

		//Passing the Values to 4th Sample Reviewed
		String FM1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		AE.SetFourthSampleReviewed(FM1);
		chiledTest.log(Status.INFO, "100 is Enterd Under Smaple Reviewed");
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=8, dependsOnMethods= {"Executing_The_Schedule_By_2nd_Auditor_Through_Express_Mode_Test"})
	public void Finalizing_The_AuditType_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 4, 0);
		RA.SetGroup(SA1);
	...
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		String Expected_Disposition1 = Lib.getCellValue(XLPATH, "Check Point", 162, 0);
		...
		String Expected_ComplianceScore1 = "Partial";
		...
		String Expected_SubmittedScore1 = "16.67";
		...
		String Expected_FinalScore1 = "16.67";
		...
		chiledTest.log(Status.INFO, "**** Checking the 2nd Checkpoint IND Score***");
		...
		String Expected_Disposition2 = Lib.getCellValue(XLPATH, "Check Point", 162, 0);
		...
		String Expected_ComplianceScore2 = "Partial";
		...
		String Expected_SubmittedScore11 = "16.67";
		...
		String Expected_FinalScore11 = "16.67";
		...
		//checking the Submitted Score
		String Actual_SubmittedScore21 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[5]")).getText();
		String Expected_SubmittedScore21 = "0.0";
		System.out.println("Submitted Score is : " + Actual_SubmittedScore21);
		System.out.println("Submitted Score is : " + Expected_SubmittedScore21);
		Assert.assertEquals(Actual_SubmittedScore21, Expected_SubmittedScore21, "Submitted Score is Wrong");
		System.out.println("Submitted Score is Matched");

		//checking the Final Score
		String Actual_FinalScore21 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_FinalScore21 = "0.0";
		System.out.println("Submitted Score is : " + Actual_FinalScore21);
		System.out.println("Submitted Score is : " + Expected_FinalScore21);
		Assert.assertEquals(Actual_FinalScore21, Expected_FinalScore21, "Final Score is Wrong");
		System.out.println("Final Score is Matched");
		...
		String Expected_Disposition211 = Lib.getCellValue(XLPATH, "Check Point", 162, 0);
		...
		//checking the Submitted Score
		String Actual_SubmittedScore211 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[5]")).getText();
		String Expected_SubmittedScore211 = "16.67";
		System.out.println("Submitted Score is : " + Actual_SubmittedScore211);
		System.out.println("Submitted Score is : " + Expected_SubmittedScore211);
		Assert.assertEquals(Actual_SubmittedScore211, Expected_SubmittedScore211, "Submitted Score is Wrong");
		System.out.println("Submitted Score is Matched");

		//checking the Final Score
		String Actual_FinalScore211 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_FinalScore211 = "16.67";
		System.out.println("Submitted Score is : " + Actual_FinalScore211);
		System.out.println("Submitted Score is : " + Expected_FinalScore211);
		Assert.assertEquals(Actual_FinalScore211, Expected_FinalScore211, "Final Score is Wrong");
		System.out.println("Final Score is Matched");

		//Checking the Is Issue
		List<WebElement> IsIssue211 = driver.findElements(By.xpath("//table[@id='review_compliance_table']/tbody/tr[1]/td[7]"));
		...
		String SA2 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_Disposition11 = Lib.getCellValue(XLPATH, "Check Point", 162, 0);
		...
		String Expected_ComplianceScore11 = "Partial";
		...
		//checking the Submitted Score
		String Actual_SubmittedScore2111 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[5]")).getText();
		String Expected_SubmittedScore2111 = "16.67";
		System.out.println("Submitted Score is : " + Actual_SubmittedScore2111);
		System.out.println("Submitted Score is : " + Expected_SubmittedScore2111);
		Assert.assertEquals(Actual_SubmittedScore2111, Expected_SubmittedScore2111, "Submitted Score is Wrong");
		System.out.println("Submitted Score is Matched");

		//checking the Final Score
		String Actual_FinalScore2111 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_FinalScore2111 = "16.67";
		System.out.println("Submitted Score is : " + Actual_FinalScore2111);
		System.out.println("Submitted Score is : " + Expected_FinalScore2111);
		Assert.assertEquals(Actual_FinalScore2111, Expected_FinalScore2111, "Final Score is Wrong");
		System.out.println("Final Score is Matched");
		...
		int dwdw = IsIssue1.size();
		System.out.println("duwbduwdb" + dwdw);
		...
		String Expected_Disposition2111 = Lib.getCellValue(XLPATH, "Check Point", 162, 0);
		...
		String Expected_ComplianceScore2111 = "Partial";
		...
		String Expected_SubmittedScore6 = "16.67";
		...
		String Expected_FinalScore6 = "16.67";
		...
		String Expected_SubmittedScore8 = "16.67";
		...
		String Expected_FinalScore8 = "16.67";
		...
		String Expected_TotalScore = "100.0 / 200.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 94, 0);
		...
		String Expected_Compliances = "50";
