...
public class RedistributionScoringLogicSubAuditsScenario2Test extends BaseTest{
	...
	public void Annexure_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Scoring Logic Sub Audits Functionality Scenario 2 Test", "Scenario-2 NA Re distrubution Logic with Positive confirmity Yes");
	...
	public void Adding_Static_Annexure_Test() throws InterruptedException
	{
		...
		String AN = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 0);
	...
	public void Adding_Dynamic_Annexure_Test() throws InterruptedException
	{
		...
		String AN1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 0);
	...
	public void Creating_Annexures_Groups_Test() throws InterruptedException
	{
		GroupPageTest AG = new GroupPageTest(driver);

		System.out.println("Creating Annexures Groups Test");

		chiledTest.log(Status.INFO, "Creating Annexures Groups Test");
		...
		String SA = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 0);
		...
		chiledTest.log(Status.INFO, "Redistrubution Scoring Logic is Selected");

		//Clicking on the Matched
		AG.ClickMatched(driver);

		//Passing the Values to Add group from excel
		String ADG = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 1);
		...
		String SG2 = Lib.getCellValue(XLPATH, "Group", 4, 0);
		AG.SetGroupType(SG2);
		chiledTest.log(Status.INFO, "Annexure Group is Selected");
		...
		//Passing the Values to Select Annexure
		String SA2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 0);
		AG.SetSelectAnnexure(SA2);
		chiledTest.log(Status.INFO, "Annexure is Selected");
		...
		//Passing the Values to Select Scoring Logic
		String SL2 = Lib.getCellValue(XLPATH, "Group", 38, 0);
		...
		//Passing the Values to Add group from excel
		String ADG2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 1);
	...
	@Test(priority=5, dependsOnMethods= {"Creating_Annexures_Groups_Test"})
	public void Creating_General_Groups_Test() throws InterruptedException
	{
		...
		String ADG = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 1);
		AG.SetAddnewGroup(ADG);
		chiledTest.log(Status.INFO, "Group Name is Entered");
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 1);
	...
	public void Adding_Four_CheckPoints_To_Static_Annexure_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 1);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 5);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 5);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 5);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 5);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 5);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 5);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 5);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 5);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_Dynamic_Annexure_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 1);
		CC.SetSearchBTN(SS);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		CC.ClickManageCheckPointHeader(driver);
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 4);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 4);
		CC.SetYestextBox(YB51);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 4);
		CC.SetYestextBox(YB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 4);
		CC.SetYestextBox(YB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 4);
		CC.SetYestextBox(YB51);
	...
	public void Creating_Sub_AuditTypes_Test() throws InterruptedException
	{
		...
		String ATN2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 2);
		...
		String SCG2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN21 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 2);
		...
		//Passing the Values to Select Group Type
		String SGT21 = Lib.getCellValue(XLPATH, "Configure Audit Type", 28, 0);
		CA.SetSelectGrouptype(SGT21);
		chiledTest.log(Status.INFO, "Annexure Group Type is Selected");
		...
		//Passing the Values to Select CheckPoint Group
		String SCG21 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 1);
		CA.SetSelectCheckPointGroup(SCG21, driver);
		chiledTest.log(Status.INFO, "Select CheckPoint Group is Entered");
		...
		//Passing the Values to Audit Type Name
		String ATN3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN4 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG4 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 1);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
		...
		//Passing the Values to select Group type
		String SA1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 2);
		...
		//Passing the Values to select Group type
		String SA2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 2);
		...
		//Passing the Values to select Group type
		String SA3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 2);
		...
		//Passing the Values to select Group type
				String SA4 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 2);
		...
		String LR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 10);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 8);
		...
		String HR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 9);
		...
		String ZR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 11);
		...
		String FT = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 13);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 14);
		...
		String ST1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 13);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 14);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 14);
	...
	public void Uploading_Annexure_Documents_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
		UA.SetAuditType(SA);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		driver.findElement(By.xpath("//select[@id='sub_audit_types']/option[contains(text(),'RDSL S2 Static Sub Audit Type')]")).click();
		...
		//Passing the Values to Audit Type
		String SA1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
		UA.SetAuditType(SA1);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//select[@id='sub_audit_types']/option[contains(text(),'RDSL S2 Dynamic Sub Audit Type')]")).click();
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
	...
	public void Audit_Execution_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
		...
		String SB11 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 2);
		...
		//Passing the Values to Search Text Filed
		String SB2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 2);
		AE.SetSearchBTN(SB2);
		...
		//Passing the Values to Search Text Filed
		String SB3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 2);
		AE.SetSearchBTN(SB3);
		...
		//Passing the Values to Search Text Filed
		String SB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 2);
		AE.SetSearchBTN(SB7);
	...
	@Test(priority=16, dependsOnMethods= {"Audit_Execution_Test"})
	public void Finalize_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 3, 3);
		...
		String SA = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 5, 2);
		RA.SetSubAudits(SA);
		...
		//Passing the Values to Sub Audit under Select Sub audit Type drop down
		String SA3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 6, 2);
		RA.SetSubAudits(SA3);
		...
		//Review Button should not display for all Not Audit sub audits
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=17, dependsOnMethods= {"Finalize_Audit_Test"})
	public void Validating_The_Scores_Test() throws InterruptedException
	{
		...
		String Expected_TotalScore = "66.68 / 85.0"; 
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 2", 4, 14);
		...
		String Expected_Compliances = "78.45";
