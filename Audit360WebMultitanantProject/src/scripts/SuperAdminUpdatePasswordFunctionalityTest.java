...
public class SuperAdminUpdatePasswordFunctionalityTest extends BaseTest {
	...
	public void Update_Password_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Super Admin Update Pasword Page Test", "Testing the Functionality of the Update Password");
