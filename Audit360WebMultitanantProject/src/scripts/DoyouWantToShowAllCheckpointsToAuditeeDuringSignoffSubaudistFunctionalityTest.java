...
public class DoyouWantToShowAllCheckpointsToAuditeeDuringSignoffSubaudistFunctionalityTest extends BaseTest {
	...
	public void Create_Audit_Type_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Do you want to show all checkpoints to auditee during signoff Functionality Test With Subaudits Level Allocation", "Testing the Functionality of the Do you want to show all checkpoints to auditee during signoff withch is mapped with Subaudits level Allocations");

		System.out.println("Do you want to show all checkpoints to auditee during signoff Functionality Test With Subaudits Level Allocation");
	...
	public void Creating_General_Group_Sub_Audit_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "CTRL-5411", 3, 0);
	...
	public void Creating_Annexure_Sub_Audit_Type_For_Dynamic_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "CTRL-5411", 4, 0);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
	...
	public void Creating_Annexure_Sub_Audit_Type_For_Static_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "CTRL-5411", 5, 0);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
	...
	public void Creating_Parent_Audit_Type_With_One_General_Group_And_Two_Annexue_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
		...
		//Clicking on the select Group type
		String SA1 = Lib.getCellValue(XLPATH, "CTRL-5411", 3, 0);
		...
		//Clicking on the select Group type
		String SA3 = Lib.getCellValue(XLPATH, "CTRL-5411", 4, 0);
		...
		//Clicking on the select Group type
		String SA4 = Lib.getCellValue(XLPATH, "CTRL-5411", 5, 0);
	...
	public void Uploading_Annexure_Documnet_Page_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
		UA.SetAuditType(SA);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		driver.findElement(By.xpath("//select[@id='sub_audit_types']/option[contains(text(),'S1 SAT')]")).click();
		...
		//Passing the Values to Audit Type
		String SA1 = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
		UA.SetAuditType(SA1);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		Thread.sleep(1000);
		//Selecting 1st option under Sub Audit type
		driver.findElement(By.xpath("//select[@id='sub_audit_types']/option[contains(text(),'S1 DAT')]")).click();
	...
	public void Validating_The_Uploaded_Documents_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "CTRL-5411", 4, 0);
		...
		//Passing the Values to Sub Audit Type
		String SA1 = Lib.getCellValue(XLPATH, "CTRL-5411", 5, 0);
	...
	public void Creating_Schedule_Test() throws InterruptedException
	{
		...
		String SAT = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
	...
	public void Executing_Audit_Type_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
		...
		//Passing the Genearl Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
		...
		String SB1 = Lib.getCellValue(XLPATH, "CTRL-5411", 3, 0); 
		AE.SetSearchBTN(SB1);
		...
		//Passing the Values to Search Text Filed
		String SB11 = Lib.getCellValue(XLPATH, "CTRL-5411", 5, 0);
		...
		//Passing the Values to Search Text Filed
		String SB41 = Lib.getCellValue(XLPATH, "CTRL-5411", 4, 0);
	...
	public void SignOff_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "CTRL-5411", 3, 0);
		...
		//checking all 4 CP are Displayed
		MA.Verify4CPAreDisplayed();
		...
		//Passing the Values to search Text Box
		String SB1 = Lib.getCellValue(XLPATH, "CTRL-5411", 4, 0);
		...
		//Passing the Values to search Text Box
		String SB2 = Lib.getCellValue(XLPATH, "CTRL-5411", 5, 0);
	...
	public void Finalize_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "CTRL-5411", 6, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "CTRL-5411", 5, 0);
		RA.SetSubAudits(SA);
		...
		//Passing the Values to Sub Audit under Select Sub audit Type drop down
		String SA1 = Lib.getCellValue(XLPATH, "CTRL-5411", 4, 0);
		RA.SetSubAudits(SA1);
		...
		//Passing the Values to Sub Audit under Select Sub audit Type drop down
		String SA2 = Lib.getCellValue(XLPATH, "CTRL-5411", 3, 0);
		RA.SetSubAudits(SA2);
