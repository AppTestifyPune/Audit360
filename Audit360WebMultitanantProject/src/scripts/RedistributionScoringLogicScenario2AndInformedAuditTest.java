...
public class RedistributionScoringLogicScenario2AndInformedAuditTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Score Logic Scenario 2 And Informed Audit Functionality Test", "Testing the Functionality of the Redistribution Score Logic no NA in any group within sub audit Through Express Mode And Informed Audit Functionality");

		chiledTest = parentTest.createNode("Creating Group Test");

		System.out.println("***Redistribution Score Logic Scenario 2 Test***");
		...
		String ADG = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 21, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 17, 0);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 21, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 21, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 17, 0);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 21, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 17, 0);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 4, 0);
		CC.SetSearchBTN(SS);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 4, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 80, 0);
		...
		CA.ClickInformedAuditRadioButton();
		...
		String FT = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
	...
	public void Super_Admin_Adding_Refernce_Files_Test() throws InterruptedException
	{
		...
		//passing the values to select Audit Type
		String SAT = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		//passing the values to select Audit Type
		String SAT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		//passing the values to select Audit Type
		String SAT3 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		//passing the values to select Audit Type
		String SAT4 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
	...
	public void Adding_The_Documents_By_Auditee_User_Test() throws InterruptedException
	{
		...
		//Checking Not Started Status schedule is Displayed or Not
		MA.VerifyNotStartedStatusIsDisplayed();
	...
	@Test(priority=9, dependsOnMethods= {"Adding_The_Documents_By_Auditee_User_Test"})
	public void Executing_The_AuditType_Through_Express_Mode_Test() throws InterruptedException
	{
		...
		String AT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT4 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		action.dragAndDrop(CP4, Yes2).build(). perform();
		...
		WebElement NA1 = driver.findElement(By.xpath("//ul[@id='sortable2']"));
		...
		System.out.println("*****Dragging 6th checkpoint to Yes Compliance********");

		chiledTest.log(Status.INFO, "*****Dragging 6th checkpoint to Yes Compliance********");
		...
		action.dragAndDrop(CP6, Yes3).build(). perform();
		chiledTest.log(Status.INFO, "sixth Checkpoint is Dragged to Yes");
		System.out.println("sixth Checkpoint is Dragged to Yes");

		Thread.sleep(2000);

		System.out.println("*****Dragging 7th checkpoint to Yes Compliance********");

		chiledTest.log(Status.INFO, "*****Dragging 7th checkpoint to Yes Compliance********");

		WebElement CP7 = driver.findElement(By.xpath("//ul[@id='sortable1']/li[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(CP7));
		WebElement Yes4 = driver.findElement(By.xpath("//ul[@id='sortable2']"));
		wait.until(ExpectedConditions.visibilityOf(Yes4));
		action.dragAndDrop(CP7, Yes4).build(). perform();
		chiledTest.log(Status.INFO, "Seventh Checkpoint is Dragged to Yes");
		System.out.println("Seventh Checkpoint is Dragged to Yes");
		...
		action.dragAndDrop(CP8, Partial).build(). perform();
		...
		//Passing the Values to Sample Passed
		String ESP = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 109, 0);
		AE.SetExpressModeSamplePassed(ESP);
		chiledTest.log(Status.INFO, "50 is Enterd Under Smaple Passed");

		//Passing the Values to Sample Reviewed
		String ESR = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 115, 0);
		AE.SetExpressModeSampleReviwed(ESR);
		...
		AE.ClickQuoteAuditReferenceBTN();

		//selecting all documents under Quote Audit Reference
		AE.SelectingAllDocumentsUnderQuoteAuditReference();

		//clicking on the submit button
		AE.ClickQuoteAuditReferenceSubmitBTN();
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=10, dependsOnMethods= {"Executing_The_AuditType_Through_Express_Mode_Test"})
	public void Finalizing_The_AuditType_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 4, 0);
		RA.SetGroup(SA1);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=11, dependsOnMethods= {"Finalizing_The_AuditType_Test"})
	public void Validating_AuditType_Scores_Test() throws Exception
	{
		LoginPageTest l=new LoginPageTest(driver);

		ReviewAuditPageTest RA = new ReviewAuditPageTest(driver);

		System.out.println("Validating AuditType Scores Test");

		chiledTest = parentTest.createNode("Validating AuditType Scores Test");
		...
		System.out.println("*****************Validating 1st Group Scoring**********************");

		chiledTest.log(Status.INFO, "**************Validating 1st Group Scoring******************");
		...
		String Actual_INDScore1 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		...
		//checking the IND Score
		String Actual_INDScore2 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_INDScore2 = "25.0";
		...
		//checking the IND Score
		String Actual_INDScore21 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		...
		//checking the IND Score
		String Actual_INDScore211 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_INDScore211 = "25.0";
		...
		String SA2 = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 4, 0);
		RA.SetGroup(SA2);
		...
		//checking the IND Score
		String Actual_INDScore11 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_INDScore11 = "25.0";
		...
		//checking the IND Score
		String Actual_INDScore2111 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_INDScore2111 = "25.0";
		...
		//checking the IND Score
		String Actual_INDScore7 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_INDScore7 = "25.0";
		...
		//checking the IND Score
		String Actual_INDScore8 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		...
		String Expected_TotalScore = "162.5 / 200.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RSL Scenarios 2", 92, 0);
		...
		String Expected_Compliances = "81.25";
		...
		//Validating the Attached schedule reference files are displayed
		Assert.assertTrue(driver.findElement(By.xpath("//p[text()='Schedule Reference:Sample-jpg-image-1mb.jpg']")).isDisplayed(), "JPG File is NOT Displayed");;
		System.out.println("JGP File is Not Displayed");
		chiledTest.log(Status.INFO, "JGP File is Not Displayed");

		Assert.assertTrue(driver.findElement(By.xpath("//p[text()='Schedule Reference: Is Confidential Annexuretemplate2.csv']")).isDisplayed(), "CSV File is NOT Displayed");;
		System.out.println("CSV File is Not Displayed");
		chiledTest.log(Status.INFO, "CSV File is Not Displayed");

		Assert.assertTrue(driver.findElement(By.xpath("//p[text()='Schedule Reference:download_pdf.pdf']")).isDisplayed(), "PDF File is NOT Displayed");;
		System.out.println("PDF File is Not Displayed");
		chiledTest.log(Status.INFO, "PDF File is Not Displayed");

		Assert.assertTrue(driver.findElement(By.xpath("//p[text()='Schedule Reference:download.jpg']")).isDisplayed(), "JPG File is NOT Displayed");;
		System.out.println("JPG File is Not Displayed");
		chiledTest.log(Status.INFO, "JPG File is Not Displayed");

		Assert.assertTrue(driver.findElement(By.xpath("//p[text()='Schedule Reference: Is Confidential Annexure_Template_For_Scoring_Logic.csv']")).isDisplayed(), "CSV File is NOT Displayed");;
		System.out.println("CSV File is Not Displayed");
		chiledTest.log(Status.INFO, "CSV File is Not Displayed");
