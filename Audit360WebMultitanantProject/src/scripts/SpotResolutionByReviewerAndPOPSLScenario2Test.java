...
public class SpotResolutionByReviewerAndPOPSLScenario2Test extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Spot Resolution By Reviewer And POPSL Scenario2 Functionality Test", "Testing the Functionality of the Percentage Of Positive Scoring Logic NA Percentage, Actual Audit Score And Handle Issue Functionality test");
		
		System.out.println("***Spot Resolution By Reviewer And POPSL Scenario2 Functionality Test***");
	   ...
	   /*//clicking on the Group Type
		...
		String ADG = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB5);

		//Passing Values to NA Text Box
		String NAB = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		CC.SetNATextBox(NAB);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB51);

		//Passing Values to NA Text Box
		String NAB1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB7);

		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 50, 0);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
		CC.SetNATextBox(NAB3);
		...
		//Passing Values to NA Text Box
		String NAB4 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 17, 0);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 4, 0);
		...
		String LR = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 76, 0);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 67, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 80, 0);
		...
		//Enabling Spot Resolutions Toggle Button
		CA.ClickSpotResultionToggleBTN();

		//clicking on the By Verifier/Reviewer
		CA.ClickSpotResolutionByReviewerRadioBTN();
		...
		//Selecting Proposed by Auditee in TAT Type
		...
		String FT = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 9, 0);
		...
		System.out.println("Fourth Checkpoint is Dragged to NA");
		...
		WebElement NO1 = driver.findElement(By.xpath("//ul[@id='sortable4']"));
		wait.until(ExpectedConditions.visibilityOf(Yes1));
		action.dragAndDrop(CP5, NO1).build(). perform();
		...
		System.out.println("*****Dragging 8th checkpoint to Yes Compliance********");

		chiledTest.log(Status.INFO, "*****Dragging 8th checkpoint to Yes Compliance********");

		WebElement CP8 = driver.findElement(By.xpath("//ul[@id='sortable1']/li[1]"));
		wait.until(ExpectedConditions.elementToBeClickable(CP8));
		WebElement Yes5 = driver.findElement(By.xpath("//ul[@id='sortable2']"));
		wait.until(ExpectedConditions.visibilityOf(Yes5));
		action.dragAndDrop(CP8, Yes5).build(). perform();
		chiledTest.log(Status.INFO, "Eighth Checkpoint is Dragged to Yes");
		System.out.println("Eighth Checkpoint is Dragged to Yes");
		...
		//enabling the 1st CP Spot Resolution Toggle button
		AE.ClickExpressModeSpotResolutionToggleBTN();

		//Uploading the Documents and adding remarks
		AE.ExpressModeSpotResolutionUploadDocuments(driver);

		//clicking on the Next Button
		AE.ClickExpressModeSpotResolutionTAbNextBTN();
	...
	//Testing the Functionality of the Sign Off Audit Test
	@Test(priority=8, dependsOnMethods= {"Audit_Execution_Tets"})
	public void SignOff_AuditType_Test() throws InterruptedException
	{
		MyAuditsPageTest MA = new MyAuditsPageTest(driver);

		LoginPageTest l=new LoginPageTest(driver);

		chiledTest = parentTest.createNode("SignOff Audit Type Test");

		System.out.println("SignOffing Audit Type Test");
		...
		System.out.println("************Rejecting the Issue for the 1st checkpoint******************");

		chiledTest.log(Status.INFO, "************Rejecting the Issue for the 1st checkpoint********************");

		//Passing the Values to Search Text Box
		String SB1 = Lib.getCellValue(XLPATH, "Check Point", 8, 0);
		...
		//Passing the Values to Comments text fields
		String CM2 = Lib.getCellValue(XLPATH, "My Audit Page", 3, 5);
		MA.SetComments(CM2);
		chiledTest.log(Status.INFO, "Comments is Entered");

		//Uploading the Documents
		MA.UploadDocumnet(driver);
		chiledTest.log(Status.INFO, "Documents is Uploaded");

		//Clicking on the Re-Examine Button
		MA.ClickReExamineButton(driver);

		//Verify Issue Rejected successfully Success Message is Displayed
		MA.VerifyIssueRejectedSuccessfullySuccessMSGIsDisplayed();
		chiledTest.log(Status.INFO, "Issue Rejected successfully Success Message is Displayed");
		...
		//Passing the Values to Search Text Box
		String SB2 = Lib.getCellValue(XLPATH, "Check Point", 125, 0);
		MA.SetSearchButton(SB2);
		chiledTest.log(Status.INFO, "CP5 is Searched");
		...
		//Passing the Values to Comments text fields
		String CM3 = Lib.getCellValue(XLPATH, "My Audit Page", 3, 5);
		MA.SetComments(CM3);
		chiledTest.log(Status.INFO, "Comments is Entered");
	...
	@Test(priority=9, dependsOnMethods= {"SignOff_AuditType_Test"})
	public void Handling_The_Issue_Test() throws Exception
	{
		chiledTest = parentTest.createNode("Handling The Issue Test");

		System.out.println("Handling The Issue Test");
		...
		String SB = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 3, 0);
		RA.SetGroup(SA);
		System.out.println("1st Group is Selected");
		chiledTest.log(Status.INFO, "1st Group is Selected");
		...
		//Checking Before Handle Issue Issue Review Button should not Display
		...
		//clicking on the Edit Checkpoint button
		RA.ClickCheckpointEditBTN();

		//Clicking on the Handle Issue Here 
		RC.ClickHandleIssuesHereBTN(driver);

		//clicking on the Retain Issue button
		RC.ClickRetainIssueBTN();

		//verifying the Comments is Required Fields
		RC.VerifyCommentIsRequiredFields();

		//Passing the Values to Comments
		String SC = Lib.getCellValue(XLPATH, "Issues", 40, 0);
		RC.SetComments(SC);

		//clicking on the Retain Issue button
		RC.ClickRetainIssueBTN();

		//Verifying Issue is retained Success Message is Displayed
		RC.VerifyIssueIsRetainedSuccessMSGISDisplayed();

		//Removing the Already Selected Group from the Select Group
		RA.ClickRemoveBTN();

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 4, 0);
		RA.SetGroup(SA1);
		System.out.println("2nd Group is Selected");
		chiledTest.log(Status.INFO, "2nd Group is Selected");
		...
		RC.ClickDropIssueBTN();

		//verifying the Comments is Required Fields
		RC.VerifyCommentIsRequiredFields();

		//Passing the Values to Comments
		String SC1 = Lib.getCellValue(XLPATH, "Issues", 40, 0);
		RC.SetComments(SC1);

		//clicking on the Drop Issue button
		RC.ClickDropIssueBTN();

		//Verifying Issue is Dropped Success Message is Displayed
		RC.VerifyIssueIsDropedSuccessMSGISDisplayed();
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=10, dependsOnMethods= {"Handling_The_Issue_Test"})
	...
	public void Validating_The_Scores_Test() throws InterruptedException
	{
		...
		String Expected_TotalScore = "168.75 / 200.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "Spot POPSL Scenario 2", 92, 0);
		...
		String Expected_Compliances = "84.38";
