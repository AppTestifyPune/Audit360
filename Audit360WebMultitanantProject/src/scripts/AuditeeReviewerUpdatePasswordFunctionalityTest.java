...
public class AuditeeReviewerUpdatePasswordFunctionalityTest extends BaseTest{
	...
	public void Update_Password_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Auditee Reviewer Update Pasword Page Test", "Testing the Functionality of the Update Password");
