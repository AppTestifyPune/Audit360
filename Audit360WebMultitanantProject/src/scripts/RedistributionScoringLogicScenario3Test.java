...
public class RedistributionScoringLogicScenario3Test extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Score Logic Scenario 3 Test", "Testing the Functionality of the Redistribution Score Logic NA distrubution based on score contribution with Partia");

		chiledTest = parentTest.createNode("Creating Group Test");

		System.out.println("Creating Group Test");

		System.out.println("***Redistribution Score Logic Scenario 3 Test***");
	   ...
	   /*//clicking on the Group Type
		...
		String ADG = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 22, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 17, 0);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 20, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 19, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 17, 0);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 18, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 17, 0);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 24, 0);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 21, 0);
		CC.SetYestextBox(YB51);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 18, 0);
		CC.SetYestextBox(YB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 29, 0);
		CC.SetYestextBox(YB8);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 9, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 4, 0);
		...
		String FO = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 95, 0);
		...
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 94, 0);
		...
		String TT = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 87, 0);
		CA.SetThirdTo(TT, driver);

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 93, 0);
		CA.SetThirdOutCome(TO1, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String FO1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 9, 0);
	...
	public void Executing_The_AuditType_Through_Express_Mode_Test() throws InterruptedException
	{
		...
		String AT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 9, 0);
		...
		String FO = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 109, 0);
		...
		String FM = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 115, 0);
		...
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 109, 0);
		AE.SetSecondSamplePassedValue(SO);
		chiledTest.log(Status.INFO, "50 is Enterd Under Smaple Passed");

		//Passing the Values to 2nd Sample Reviewed
		String SM = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 115, 0);
	...
	public void Finalizing_The_AuditType_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 4, 0);
		RA.SetGroup(SA1);
	...
	public void Validating_Scores_Test() throws Exception
	{
		...
		chiledTest = parentTest.createNode("Validating Score Test");

		System.out.println("Validating AuditType Scores Which Has Executed Through Express Mode Test");
		...
		String SA2 = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_TotalScore = "119.31 / 155.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RSL Scenarios 3", 93, 0);
		...
		String Expected_Compliances = "76.97";
