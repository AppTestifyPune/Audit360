...
public class EditSheduleRejectFunctionalityTest extends BaseTest {
	...
	public void Creating_Audit_Type_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Edit Schedule Reject Functionality Test", "Testing The Search Functionality of the Approved Search Text Fileds, Testing the Approval Page etc..");
		...
		String ATN = Lib.getCellValue(XLPATH, "Approve Schedule", 3, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Approve Schedule", 3, 0);
	...
	public void Creating_Schedule_Test() throws InterruptedException
	{
		...
		chiledTest = parentTest.createNode("Creating Schedule For Edit Audit Test");

		System.out.println("Creating Schedule For Edit  Audit Test");
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Approve Schedule", 3, 0);
	...
	public void Edit_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Approve Schedule", 3, 0);
	...
	//Testing the Functionality of the Reject Request Test
	@Test(priority=5, dependsOnMethods= {"Edit_Audit_Schedule_Test"})
	public void Request_Reject_Test() throws InterruptedException
	{
		//SM Modified
		try
		{
		...
		//Passing the Values to Select Audit Type
		String AT = Lib.getCellValue(XLPATH, "Approve Schedule", 3, 0);
		AP.SetAuditType(AT);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		String ATN = Lib.getCellValue(XLPATH, "Approve Schedule", 3, 0);
		WebElement AuditTypeName = driver.findElement(By.xpath("//table[@id='acceptedScheduleTableData']/tbody/tr[1]/td[2]"));
		...
		//Verifying Do you want to reject this request Pop Up is Displayed
		AP.VerfiyDoYouWantToRejectThisRequestPopUpIsDisplayed();

		//Clicking on the OK Button
		AP.ClickOKButton(driver);

		//Verifying Schedule Updated Successfully Message is Displayed
		AP.VerifyScheduleUpdatedRejectedSuccessfullyMSGIsDisplayed(driver);
		chiledTest.log(Status.INFO, "Schedule update request rejected Successfully is Displayed");
