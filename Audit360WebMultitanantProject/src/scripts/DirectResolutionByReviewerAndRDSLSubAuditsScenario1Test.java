...
public class DirectResolutionByReviewerAndRDSLSubAuditsScenario1Test extends BaseTest {
	...
	public void Annexure_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Direct Resolution By Reviewer And RDSL Sub Audits Functionality Scanrio 1 Test", "Scenario-1 NA Re distrubution Logic with Positive confirmity NO");

		System.out.println("*****Direct Resolution By Reviewer And RDSL Sub Audits Functionality Scanrio 1 Test****");
	...
	public void Adding_Static_Annexure_Test() throws InterruptedException
	{
		...
		String AN = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 0);
	...
	public void Creating_Static_Annexure_Group_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 0);
		...
		String ADG = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 1);
	...
	public void Creating_General_Groups_Test() throws InterruptedException
	{
		...
		String ADG = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 1);
		AG.SetAddnewGroup(ADG);
		chiledTest.log(Status.INFO, "Group Name is Entered");
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 1);
	...
	public void Adding_Four_CheckPoints_To_Static_Annexure_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 1);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 7, 4);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 5);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 4);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 6, 5);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 4);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 5);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 4);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 5);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		CC.ClickManageCheckPointHeader(driver);
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 1);
		CC.SetSearchBTN(SS);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 8, 4);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 8, 5);
		CC.SetNoTextBox(NB51);
		...
		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 5);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 9, 4);
		CC.SetYestextBox(YB8);
	...
	@Test(enabled=true,priority=8/*, dependsOnMethods= {"Adding_Four_CheckPoints_To_another_Group_Test"}*/)
	public void Creating_Sub_AuditTypes_Test() throws InterruptedException
	{
		...
		String ATN2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 2);
		...
		String SCG2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN3 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG3 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN4 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG4 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 1);
	...
	@Test(enabled=true,priority=9, dependsOnMethods= {"Creating_Sub_AuditTypes_Test"})
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 3);
		...
		//Passing the Values to select Group type
		String SA1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 2);
		...
		//Passing the Values to select Group type
		String SA2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 2);
		...
		//Passing the Values to select Group type
		String SA3 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 2);
		...
		String LR = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 10);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 8);
		...
		String HR = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 9);
		...
		String ZR = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 11);
		...
		//clicking on the Direct Resolution Toggle button
		CA.ClickDirectResultionToggleBTN();

		//clicking on the By Reviewer/Verifier
		CA.ClickDirectResolutionByReviewerRadioBTN();
		...
		//Selecting the Based On Audit Signoff TAT Type
		String ST = Lib.getCellValue(XLPATH, "Configure Audit Type", 66, 0);
		CA.SetSelectTATType(ST);
		chiledTest.log(Status.INFO, "Proposed By Auditee Selected in TAT Type");
		...
		String FT = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 13);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 14);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 13);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 14);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 14);
	...
	@Test(enabled=true,priority=10, dependsOnMethods= {"Creating_Parent_Audit_Type_Test" })
	public void Uploading_Annexure_Documents_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 3);
		UA.SetAuditType(SA);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
	...
	@Test(enabled=true,priority=11 , dependsOnMethods= {"Uploading_Annexure_Documents_Test"})
	...
	@Test(enabled=true,priority=12,dependsOnMethods= {"Auditee_Admin_Configuration_Test"})
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 3);
	...
	@Test(enabled=true,priority=13, dependsOnMethods= {"Creating_Audit_Schedule_Test"})
	public void Audit_Execution_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 3);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 3);
		...
		String SB11 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 2);
		...
		//Passing the Values to Search Text Filed
		String SB2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 2);
		AE.SetSearchBTN(SB2);
		...
		//Passing the Values to Search Text Filed
		String SB3 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 2);
		AE.SetSearchBTN(SB3);
	...
	@Test(enabled=true,priority=14, dependsOnMethods= {"Audit_Execution_Test"})
	public void SignOff_Audit_Test() throws Exception
	{
		...
		System.out.println("************Singoffing the 1st Gen Sub Audit Type************");

		chiledTest.log(Status.INFO, "***********Singoffing the 1st Gen Sub Audit Type************");

		//Passing the Values to search Text Box
		String SB = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 2);
		MA.SetSearchButton(SB);
		chiledTest.log(Status.INFO, "1st Gen Sub Audit Is Searched");
		...
		String DD = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 7, 2);
		...
		System.out.println("************Singoffing the 2nd Gen Sub Audit Type************");

		chiledTest.log(Status.INFO, "***********Singoffing the 2nd Gen Sub Audit Type************");
    /*  gggcg
     */ 
     ...
     //#SM Temp
		...
		String SB1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 2);
		...
		String SB11 = Lib.getCellValue(XLPATH, "Check Point", 128, 0);
		MA.SetSearchButton(SB11);
		chiledTest.log(Status.INFO, "CP8 is Searched");
		...
		//#SM Hre skiping because when Res clicked Direct resol. button auto clicked
	//	MA.ClickDirectResolutionCheckBox();
        
		
		Thread.sleep(1000);
		//Re Examine Button should not be display
		MA.VerifyReExamineButtonShouldNotDisplay();
	
		//clicking on the accept button
		MA.ClickAcceptBTN(driver);

		
	//checking Due date is Required Filed
	//#SM Modify this Because is not based on Proposed by Auditee. 
	//	MA.VerifyDuedateIsRequired();
		...
		//Passing the Values to Due Date
		String DD1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 7, 2);
	//	
	//  SM Modify Because Due date is not required for Based on Audit Finalization Tat type
	//	MA.SetDueDate(DD1, driver);
        

		
	//Passing the Values to Comments//Already set commnet//#SM
	//	String CM = Lib.getCellValue(XLPATH, "My Audit Page", 3, 5);
	//	MA.SetComments(CM);
		...
		Thread.sleep(2000); //Verification message not showing
	//	MA.VerifyIssueAcceptedSuccessfullySuccessMSGIsDisplayed();//#SM This message is not showing on screen
		
		//Clicking on the Sing Off Audit Button
		MA.ClickSingOffAuditButton(driver);
		
		//#SM Modify This is Extra
		try {
		//#SM Modify This is Extra
		String DD3 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 7, 2);
		//SElect tat type was Depend on Audit Exicution
		...
		//#SM../Modify Copy for Upper coding 
		...
		//Passing the Values to search Text Box
		String SB2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 2);
		MA.SetSearchButton(SB2);
		chiledTest.log(Status.INFO, "Satic Sub Audit Is Searched");
		...
		//Passing the Cp2 to Search text fields
		String SB111 = Lib.getCellValue(XLPATH, "Check Point", 9, 0);
		MA.SetSearchButton(SB111);
		chiledTest.log(Status.INFO, "CP4 is Searched");

		//clicking on the Res Button
		MA.ClickResButton(driver);
		Thread.sleep(2000);//wait for Element catch
		

		//clicking on the Direct Resolution Check box
		//here We are commenting Because  res button is clicked then Not required to click Direct resolution.
	//	MA.ClickDirectResolutionCheckBox();
		...
		//#SM Modify this Because is not based on Proposed by Auditee. 
		//checking Due Date is Reqired filed
	//	MA.VerifyDuedateIsRequired();
        
		
		//verifying Comments is Required
		MA.VerifyCommentsIsReauiredFiled();
		//#SM Comment this because there is no element

		//#SM Adding Extra for 
		String CM1 = Lib.getCellValue(XLPATH, "My Audit Page", 3, 5);
		MA.SetComments(CM1);
		...
		//Passing the Values to Due Date
		String DD2 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 7, 2);
		//#SM Modify set due date not clickable Because Select tat type is based on Audit finalization
	//	MA.SetDueDate(DD2, driver);
        

		//Passing the Values to Comments
		//#SM Removing this bcoz its added Already
		String CM2 = Lib.getCellValue(XLPATH, "My Audit Page", 3, 5);
		MA.SetComments(CM2);
	    ...
	    MA.ClickAcceptBTN(driver);
	    Thread.sleep(2000);//#SM Temprorry
		
	    // #SM Comments Just for Verify manually
	    //Also the message is not showing
		//checking Issue Accepted successfully MSG is Displayed
		Thread.sleep(600);
	...
	//	MA.SetDueDate(DD3, driver);
		...
		try 
		{
		String DD4 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 7, 2);
		//SElect tat type was Depend on Audit Exicution
	...
	@Test(enabled=true,priority=15, dependsOnMethods= {"SignOff_Audit_Test"})
	public void Clsoing_And_Finalizing_The_Audit_Test() throws InterruptedException
	{
		chiledTest = parentTest.createNode("Closing And Finalizing The Audit Test");

		System.out.println("Closing And Finalizing The Audit Test");
		...
		driver.navigate().refresh();//#SM Added
		//Passing the Values to Search Text field
		String SB = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 3);
		...
		String SA = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 5, 2);
		RA.SetSubAudits(SA);
		...
		Thread.sleep(1000);
		//Checking the Review Button should disabled
		RA.VerifyReviewBTNIsDisabled();
		
		
		//clicking on the Direct Resolutions Legends
		RA.ClickDirectResolutionLegends();
		...
		Thread.sleep(1000);
		//checking Direct resolution score is Required Field
		RC.VerifyDirectResolutionScoreIsRequiredFiled();

		//Passing the Value to Direct Resolution Score
		String DRS = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 4, 17);
		RC.SetDirectResolutionScore(DRS);

		//clicking on the Close Button
		RC.ClickCloseButton();

		//checking Resolution Done Success message is Displayed
	//	RA.VerifyResolutionIsDoneSucessMSGIsDisplayed(); //#SM Commented Because Elenet is not able to find
		...
		//clicking on the Edit CP Button
		RA.ClickCheckpointEditBTN();

		//clicking on the Close Button
		RC.ClickCloseButton();

		//Checking Direct Resolution score is Required filed
		RC.VerifyDirectResolutionScoreIsRequiredFiled();

		//Passing the Value to Direct Resolution Score
		String DRS1 = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 17);
		RC.SetDirectResolutionScore(DRS1);

		//clicking on the Close Button
		RC.ClickCloseButton();

		//checking Resolution Done Success message is Displayed
	//	RA.VerifyResolutionIsDoneSucessMSGIsDisplayed();//#SM Commented Bcoz This elemnt is not able to find
  ...
  /*
	//Testing the Functionality of the Audit Execution page
	@Test(enabled=false,priority=16 , dependsOnMethods= {"Clsoing_And_Finalizing_The_Audit_Test"})
	public void Validating_The_Scores_Test() throws InterruptedException
	{
		...
		Thread.sleep(3000);//#SM modify
		driver.navigate().refresh();//#SM modify//Taking time for score display
		l.ClickProfileBTN(driver);

		l.ClickLogoutBTN();
		
		Thread.sleep(7000);//This wait for Score card
		driver.navigate().refresh();//#SM modify//Taking time for score display
		Thread.sleep(1000);
	...
	//	RA.ClickReviewAuditHeader(driver);//#SM Commented
	...
	//	String Expected_TotalScore = "212.99 / 230.0"; //#SM
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "Direct RDSL SubAudits Scenario1", 3, 14);
	...
	//	String Expected_Compliances = "92.6";//#SM
