...
public class AuditeeTemplateFunctionalityTest extends BaseTest {

	//Testing the Functionality of the Configure Audit page
	@Test(priority=1)
	public void Auditee_Upload_Test() throws InterruptedException
	{
		LoginPageTest l=new LoginPageTest(driver);

		parentTest = extent.createTest("Auditee Upload Functionality Test", "Testing the Functionality of the Auditee Upload");

		chiledTest = parentTest.createNode("Auditee Upload Functionality Test");

		System.out.println("Auditee Upload Functionality Test");
		...
		String DT = Lib.getCellValue(XLPATH, "Template", 4, 0);
		TP.SetSelectDocumnetType(DT);

		TP.ClickMatched();

		//Uploading the Cluster Documents
		TP.UploadAuditeeDocument();
