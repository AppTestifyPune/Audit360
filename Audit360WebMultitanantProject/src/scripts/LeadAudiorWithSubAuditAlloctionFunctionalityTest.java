...
public class LeadAudiorWithSubAuditAlloctionFunctionalityTest extends BaseTest {
	...
	public void Annexure_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Lead Auditor With Sub Audit Level Alloction Functionality Test", "Testing the functionality of Lead Auditor With Sub Audit Level Alloction test");
	...
	public void Adding_Static_Annexure_Test() throws InterruptedException
	{
		...
		String AN = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 0);
	...
	public void Adding_Dynamic_Annexure_Test() throws InterruptedException
	{
		...
		String AN1 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 0);
	...
	public void Creating_Annexures_Group_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 0);
		...
		String ADG = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 1);
		...
		//Passing the Values to Select Annexure
		String SA1 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 0);
		...
		//Passing the Values to Add group from excel
		String ADG1 = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 1);
	...
	public void Creating_General_Groups_Test() throws InterruptedException
	{
		...
		String ADG = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 1);
		AG.SetAddnewGroup(ADG);
		chiledTest.log(Status.INFO, "Group Name is Entered");
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 1);
		AG.SetAddnewGroup(ADG1);
		chiledTest.log(Status.INFO, "Group Name is Entered");
	...
	public void Creating_Exceptional_Groups_Test() throws InterruptedException
	{
		...
		//Passing the Values to Add group 
		String ADG = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 1);
		AG.SetAddnewGroup(ADG);
		chiledTest.log(Status.INFO, "Group Name is Entered");
	...
	public void Adding_Four_CheckPoints_To_Static_Annexure_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 1);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 5);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 5);
		CC.SetNoTextBox(NB5);

		//Passing Values to NA Text Box
		String NAB = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 6);
		CC.SetNATextBox(NAB);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 5);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 5);
		CC.SetNoTextBox(NB51);

		//Passing Values to NA Text Box
		String NAB1 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 6);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 5);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 5);
		CC.SetNoTextBox(NB7);

		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Lead Auditor", 8, 6);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 5);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 5);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 6);
	...
	public void Adding_Four_CheckPoints_To_Dynamic_Annexure_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 6);
		CC.SetNATextBox(NAB2);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		CC.ClickManageCheckPointHeader(driver);
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 4);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 4);
		CC.SetYestextBox(YB51);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 4);
		CC.SetYestextBox(YB7);
		...
		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 6);
		CC.SetNATextBox(NAB2);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 4);
		CC.SetYestextBox(YB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 4);
		CC.SetYestextBox(YB51);
		...
		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Lead Auditor", 9, 6);
		CC.SetNATextBox(NAB2);
		...
		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Lead Auditor", 10, 6);
		CC.SetNATextBox(NAB3);
		...
		//Passing Values to NA Text Box
		String NAB4 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 6);
	...
	public void Adding_The_4_Types_Of_Checkpoints_To_Exceptional_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 1);
		CC.SetSearchBTN(SS);
	...
	public void Creating_Sub_AuditTypes_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 2);
		...
		String SCG = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN2 = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG2 = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN3 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG3 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 1);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG4 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN21 = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG10 = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 1);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
		...
		//Passing the Values to select Group type
		String SA1 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 2);
		...
		//Passing the Values to select Group type
		String SA3 = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 2);
		...
		//Passing the Values to select Group type
		String SA4 = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 2);
		...
		//Passing the Values to select Group type
		String SA5 = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 2);
		...
		String HR = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 9);
		...
		String ZR = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 11);
		...
		String FT = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 13);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 14);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 13);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 14);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 14);
	...
	public void Uploading_Annexure_Documents_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
		UA.SetAuditType(SA);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		driver.findElement(By.xpath("//select[@id='sub_audit_types']/option[contains(text(),'Lead Static Sub Audit Type')]")).click();
		...
		//Passing the Values to Audit Type
		String SA1 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
		UA.SetAuditType(SA1);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//select[@id='sub_audit_types']/option[contains(text(),'Lead Dynamic Sub Audit Type')]")).click();
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
	...
	public void Lead_Auditor_Not_Accepted_Button_Should_Display_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
	...
	@Test(priority=18, dependsOnMethods= {"Lead_Auditor_Not_Accepted_Button_Should_Display_Test"})
	public void Lead_Auditor_Allocation_Test() throws InterruptedException
	{
		...
		String AL = Lib.getCellValue(XLPATH, "Audit Execution", 126, 0);
		LA.SetAuditConfigurationLevel(AL);
		chiledTest.log(Status.INFO, "Subaudit is Selected under Select Audit Configuration level");

		AE.ClickMatched();

		//****Selecting 1st Sub audit for 1st auditor****
		String FS = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 2);
		LA.SetFirstSubAudit(FS);

		AE.ClickMatched();

		//****Selecting 2nd Sub audit for 1st auditor****
		String SS = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 2);
		LA.SetSecondSubAudit(SS);

		AE.ClickMatched();

		//****Selecting 3rd and 4th sub audit for 3rd auditor****
		String TS = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 2);
		LA.SetThirdSubAudit(TS);

		AE.ClickMatched();

		String TS1 = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 2);
		LA.SetThirdSubAudit(TS1);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=19, dependsOnMethods= {"Lead_Auditor_Allocation_Test"})
	public void Executing_The_Schedule_By_1st_Audior_Test() throws InterruptedException
	{
		LoginPageTest l=new LoginPageTest(driver);

		AuditExecutionPageTest AE = new AuditExecutionPageTest(driver);

		chiledTest = parentTest.createNode("Executing The Schedule By 1st Audior Test");

		System.out.println("Executing The Schedule By 1st Audior Test");
		...
		//Passing the Parent Audit type to Audit Type
		String AT2 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
		AE.SetAuditType(AT2, driver);
		chiledTest.log(Status.INFO, "Audit Type is Searched");
		...
		String SB13 = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 2);
		...
		AE.ClickTaskCompletedButton();

		//verifying Task completed Success message is Displayed
		AE.VerifyTaskCompletedSuccessfullyMSGIsDisplayed();
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=20, dependsOnMethods= {"Executing_The_Schedule_By_1st_Audior_Test"})
	public void Executing_The_Schedule_By_2nd_Audior_Test() throws InterruptedException
	{
		LoginPageTest l=new LoginPageTest(driver);

		AuditExecutionPageTest AE = new AuditExecutionPageTest(driver);

		chiledTest = parentTest.createNode("Executing The Schedule By 2nd Audior Test");

		System.out.println("Executing The Schedule By 2nd Audior Test");
		...
		//Passing the Values to Search Text Filed
		String SB3 = Lib.getCellValue(XLPATH, "Lead Auditor", 7, 2); 
		AE.SetSearchBTN(SB3);
		...
		//Passing the Values to Search Text Filed
		String SB7 = Lib.getCellValue(XLPATH, "Lead Auditor", 6, 2);
		AE.SetSearchBTN(SB7);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=21, dependsOnMethods= {"Executing_The_Schedule_By_2nd_Audior_Test"})
	public void Executing_The_Schedule_By_Lead_Audior_Test() throws InterruptedException
	{
		LoginPageTest l=new LoginPageTest(driver);

		AuditExecutionPageTest AE = new AuditExecutionPageTest(driver);

		chiledTest = parentTest.createNode("Executing The Schedule By Lead Audior Test");

		System.out.println("Executing The Schedule By Lead Audior Test");
		...
		//Passing the Values to Search Text Filed
		String SB11 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 2);
	...
	@Test(priority=22, dependsOnMethods= {"Executing_The_Schedule_By_Lead_Audior_Test"})
	public void Finalize_Audit_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 3);
		...
		String SA = Lib.getCellValue(XLPATH, "Lead Auditor", 5, 2);
		RA.SetSubAudits(SA);
		...
		String SA2 = Lib.getCellValue(XLPATH, "Lead Auditor", 3, 1);
		RA.SetGroup(SA2);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA3 = Lib.getCellValue(XLPATH, "Lead Auditor", 4, 1);
		RA.SetGroup(SA3);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=23, dependsOnMethods= {"Finalize_Audit_Test"})
	public void Validating_The_Scores_Test() throws InterruptedException
	{
		...
		String Expected_Compliances = "64";
