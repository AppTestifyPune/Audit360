...
public class RedistributionScoringLogicScenario5Test extends BaseTest {
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		chiledTest.log(Status.INFO, "Proposed By Auditee is Selected Under TAT Type");
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=8, dependsOnMethods= {"Audit_Execution_Tets"}, enabled=false)
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=9, dependsOnMethods= {"Finalizing_The_AuditType_Test"}, enabled=false)
