...
public class AddingCPWithGroupsThroughExpressModeFunctionalityTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Adding Checkpoint During Execution Through Express Mode which is Mapped with Groups Level Functionality Test", "Testing the Functionality of the Adding during CP which is mapped with Groups level allocation Through Express Mode of Execution");

		System.out.println("***Adding Checkpoint During Execution Through Express Mode which is Mapped with Groups Level Functionality Test***");
		...
		String ADG = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 22, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 29, 0);
		CC.SetNoTextBox(NB5);

		//Passing Values to NA Text Box
		String NAB = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 41, 0);
		CC.SetNATextBox(NAB);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 22, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 29, 0);
		CC.SetNoTextBox(NB51);

		//Passing Values to NA Text Box
		String NAB1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 41, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 22, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 29, 0);
		CC.SetNoTextBox(NB7);

		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 41, 0);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 22, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 29, 0);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 44, 0);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 41, 0);
		CC.SetNATextBox(NAB3);
		...
		//Passing Values to NA Text Box
		String NAB4 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 41, 0);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 4, 0);
		...
		String LR = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 76, 0);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 67, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 80, 0);
		...
		String FT = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 9, 0);
		...
		//checking total 8 Cp's are displayed
		AE.Verify8CPIsDisplayedInExpressMode();
		...
		String EN = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		...
		String EN1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 5, 0);
		...
		System.out.println("**************Adding New CP*****************");

		chiledTest.log(Status.INFO, "**************Adding New CP *****************");
		...
		String SG = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		...
		//Passing the Values to Select Group
		String SG1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		...
		//Checking 10 Cp's are displayed
		AE.Verify10CPIsDisplayedInExpressMode();

		System.out.println("*****************Dragging All CheckPoints To NA*************************");

		chiledTest.log(Status.INFO, "*****************Dragging All CheckPoints To NA********************");

		Thread.sleep(4000);
		WebDriverWait wait = new WebDriverWait(driver, 20);
		List<WebElement> sourceLocator = driver.findElements(By.xpath("//ul[@id='sortable1']/li/div[1]/div"));
		//Dragging all the checkpoints to NA
		WebElement targetLocator = driver.findElement(By.xpath("//ul[@id='sortable4']"));
		for(int i=0; i<sourceLocator.size(); i++)
		{
			WebElement All = sourceLocator.get(i);
		...
		//Passing the Values to Text
		String TT1 = Lib.getCellValue(XLPATH, "Audit Execution", 41, 0);
		AE.SetSecondText(TT1);
	...
	public void Before_Approval_CP_Should_Not_Reflect_In_Groups_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		AG.SetSearchBox(SB);
		...
		//passing the values to the Search Text Box
		String SB1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 4, 0);
		AG.SetSearchBox(SB1);
		...
		//passing the values to the Search Text Box
		String SB2 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 5, 0);
		AG.SetSearchBox(SB2);
	...
	public void Approving_The_Newly_added_CP_And_Audit_Finalzation_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		RA.SetGroup(SA);
		...
		//clicking on the New Checkpoint Lengeds
		...
		//Passing the 1st group
		String SA1 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 5, 0);
		RA.SetGroup(SA1);
		...
		//Passing the 1st group
		String SA2 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 3, 0);
		RA.SetGroup(SA2);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA3= Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 4, 0);
		RA.SetGroup(SA3);

		RA.ClickMatchedTextOption(driver);

		//Passing the 3rd group
		String SA4 = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 5, 0);
		RA.SetGroup(SA4);
	...
	public void Validating_The_Scores_Test() throws InterruptedException
	{
		...
		String Expected_TotalScore = "20.0 / 200.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "Add CP GP Express Mode", 94, 0);
		...
		String Expected_Compliances = "10.0";
