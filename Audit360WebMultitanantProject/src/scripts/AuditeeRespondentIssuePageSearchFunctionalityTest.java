...
public class AuditeeRespondentIssuePageSearchFunctionalityTest extends BaseTest {
	...
	public void Issues_Page_Test() throws InterruptedException{
		...
		parentTest = extent.createTest("Auditee Respondent Issues Page Search Functionality Test", "Testing the Functionality Respondent Issue Page, Search Criteria..");

		chiledTest = parentTest.createNode("Auditee Respondent Issues Page Search Functionality Test");

		System.out.println("Auditee Respondent Issues Page Search Functionality Test");
