...
public class AddingCPWithGroupsThroughNoramlModeFunctionaityTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Adding Checkpoint During Execution Through Normal Mode which is Mapped with Groups Level Functionality Test", "Testing the Functionality of the Adding during CP which is mapped with Groups level allocation Through Normal Mode of Execution");

		System.out.println("***Adding Checkpoint During Execution Through Normal Mode which is Mapped with Groups Level Functionality Test***");
		...
		String ADG = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 22, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 29, 0);
		CC.SetNoTextBox(NB5);

		//Passing Values to NA Text Box
		String NAB = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 41, 0);
		CC.SetNATextBox(NAB);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 22, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 29, 0);
		CC.SetNoTextBox(NB51);

		//Passing Values to NA Text Box
		String NAB1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 41, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 22, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 29, 0);
		CC.SetNoTextBox(NB7);

		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 41, 0);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 22, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 29, 0);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 44, 0);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 41, 0);
		CC.SetNATextBox(NAB3);
		...
		//Passing Values to NA Text Box
		String NAB4 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 41, 0);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 4, 0);
		...
		String LR = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 76, 0);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 67, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 80, 0);
		...
		String FT = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 9, 0);
		...
		String EN = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		...
		String EN1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 5, 0);
		...
		System.out.println("************** Executing the 1st Group CP*****************");

		chiledTest.log(Status.INFO, "************** Executing the 1st Group CP *****************");

		//Validating 4 CP should display
		...
		String SG = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		CC.SetSelectGroup(SG);

		CC.ClickMatched(); 

		System.out.println("******** Passing Already Exist CP Intent **********");

		chiledTest.log(Status.INFO, "******** Passing Already Exist CP Intent *********");
		...
		//Checking intent Has already Taken Error message is Displayed or not
		AE.VerifyIntentHasAlreadyBeenTakenErrorMSGIsDisplayed();
		...
		//Passing the Values to Select Group
		String SG1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		...
		System.out.println("********************Executing 1st Check Point*************************");

		chiledTest.log(Status.INFO, "*****************Executing 1st Check Point********************");
		...
		System.out.println("***********************Executing 2nd Check Point*************************");

		chiledTest.log(Status.INFO, "*****************Executing 2nd Check Point********************");
		...
		System.out.println("***********************Executing 3rd Check Point*************************");

		chiledTest.log(Status.INFO, "*****************Executing 3rd Check Point********************");
		...
		System.out.println("**********************Executing 4th Check Point*************************");

		chiledTest.log(Status.INFO, "*****************Executing 4th Check Point********************");
		...
		System.out.println("**********************Executing 5th newly added Check Point*************************");

		chiledTest.log(Status.INFO, "********************Executing 5th newly added Check Point********************");

		Thread.sleep(5000);

		//Passing the Values to Enter Remarks
		String ER15 = Lib.getCellValue(XLPATH, "Audit Execution", 15, 0);
		AE.SetEnterRemarks(ER15);
		chiledTest.log(Status.INFO, "Remarks is Entered");

		//Passing the Values to Enter confidential Remarks
		String ECR15 = Lib.getCellValue(XLPATH, "Audit Execution", 30, 0);
		...
		String MV1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 102, 0);
	...
	public void Before_Approval_CP_Should_Not_Reflect_In_Groups_Test() throws InterruptedException
	{
		chiledTest = parentTest.createNode("Before Approval CP Should Not Reflect In Groups Test");

		System.out.println("Before Approval CP Should Not Reflect In Groups Test");
		...
		String SB = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		AG.SetSearchBox(SB);
		...
		//passing the values to the Search Text Box
		String SB1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 4, 0);
		AG.SetSearchBox(SB1);
		...
		//passing the values to the Search Text Box
		String SB2 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 5, 0);
		AG.SetSearchBox(SB2);
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=9, dependsOnMethods= {"Before_Approval_CP_Should_Not_Reflect_In_Groups_Test"})
	public void Approving_The_Newly_added_CP_And_Audit_Finalzation_Test() throws Exception
	{
		chiledTest = parentTest.createNode("Approving The Newly Added CP And Audit Finalzation Test");

		System.out.println("Approving The Newly Added CP And Audit Finalzation Test");
		...
		String SB = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 9, 0);
		...
		//Validating total 3 Groups Displayed under Select Group drop down list
		List<WebElement> GroupsNo = driver.findElements(By.xpath("//select[@id='review_group']//option"));
		int Actaul_GroupsNO = GroupsNo.size();
		int Expected_GroupsNo = 3;
		Assert.assertEquals(Actaul_GroupsNO, Expected_GroupsNo, "Total 3 Groups are Not Displayed under Select Grpups Dropdown List");
		System.out.println("Total 3 Groups are Not Displayed under Select Grpups Dropdown List");
		chiledTest.log(Status.INFO, "Total 3 Groups are Not Displayed under Select Grpups Dropdown List");

		System.out.println("***** Approving the 1st Group CP****");

		chiledTest.log(Status.INFO, "****** Approving the 1st Group CP*****");

		//Removing the Already Selected Group from the Select Group
		RA.ClickRemoveBTN();

		//Passing the 1st group
		String SA = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//clicking on fifth CP
		...
		System.out.println("***** Approving the newly added Group CP****");

		chiledTest.log(Status.INFO, "****** Approving the newly added Group CP*****");

		//Removing the Already Selected Group from the Select Group
		RA.ClickRemoveBTN();

		//Passing the 1st group
		String SA1 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 5, 0);
		RA.SetGroup(SA1);

		RA.ClickMatchedTextOption(driver);

		//clicking on first CP
		...
		//Passing the 1st group
		String SA2 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 3, 0);
		RA.SetGroup(SA2);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA3= Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 4, 0);
		RA.SetGroup(SA3);

		RA.ClickMatchedTextOption(driver);

		//Passing the 3rd group
		String SA4 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 5, 0);
		RA.SetGroup(SA4);
		...
		//verifying 10 Checkpoints is Displayed or not
		RA.Verify10CheckpointsAreDisplayed();
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=10, dependsOnMethods= {"Approving_The_Newly_added_CP_And_Audit_Finalzation_Test"})
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		//checking the Disposition
		String Actual_Disposition5 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[4]")).getText();
		String Expected_Disposition5 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		System.out.println("Actual Disposition is : " + Actual_Disposition5);
		System.out.println("Expected Disposition is : " + Expected_Disposition5);
		Assert.assertEquals(Actual_Disposition211, Expected_Disposition211, "Disposition is Wrong");
		System.out.println("Disposition is Matched");

		//checking the Compliance Score
		String Actual_ComplianceScore5 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[3]")).getText();
		String Expected_ComplianceScore5 = "NO";
		System.out.println("Actual Compliance Score is : " + Actual_ComplianceScore5);
		System.out.println("Expected Compliance Score is : " + Expected_ComplianceScore5);
		Assert.assertEquals(Actual_ComplianceScore211, Expected_ComplianceScore211, "Compliance Score is Wrong");
		System.out.println("Compliance Score is Matched");

		String Actual_SubmittedScore5 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[5]")).getText();
		String Expected_SubmittedScore5 = "";
		...
		//checking the Input Values
		String Actual_InputValues5 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[7]")).getText();
		String Expeected_InputValues5 = "";
		System.out.println("Actual Input Values is : " + Actual_InputValues5);
		System.out.println("Expected Input Values is : " + Expeected_InputValues5);
		Assert.assertEquals(Actual_InputValues5, Expeected_InputValues5, "Input Values is Wrong");
		System.out.println("Input Values is Matched");

		//Checking the Is Issue
		List<WebElement> IsIssue5 = driver.findElements(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[8]"));
		Assert.assertTrue(IsIssue5.size()>=0, "IsIssue should Not be Empty");

		System.out.println("**** Validating the 2nd Group****");
		...
		String SA2 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 4, 0);
		RA.SetGroup(SA2);
		...
		//checking the Submitted Score
		String Actual_SubmittedScore51 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[5]")).getText();
		String Expected_SubmittedScore51 = "0.0";
		System.out.println("Submitted Score is : " + Actual_SubmittedScore51);
		System.out.println("Submitted Score is : " + Expected_SubmittedScore51);
		Assert.assertEquals(Actual_SubmittedScore51, Expected_SubmittedScore51, "Submitted Score is Wrong");
		System.out.println("Submitted Score is Matched");

		//checking the Final Score
		String Actual_FinalScore51 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[6]")).getText();
		String Expected_FinalScore51 = "0.0";
		System.out.println("Submitted Score is : " + Actual_FinalScore51);
		System.out.println("Submitted Score is : " + Expected_FinalScore51);
		Assert.assertEquals(Actual_FinalScore51, Expected_FinalScore51, "Final Score is Wrong");
		System.out.println("Final Score is Matched");

		//checking the Input Values
		List<WebElement> InputValues1 = driver.findElements(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[7]"));
		Assert.assertTrue(InputValues1.size()>=0, "Input Values should Not be Empty");
		...
		System.out.println("**** Validating the 3rd Group IND Score***");

		chiledTest.log(Status.INFO, "**** Validating the 3rd Group IND Score***");

		//Removing the Already Selected Group from the Select Group
		RA.ClickRemoveBTN();

		//Passing the 1st group
		String SA3 = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 5, 0);
		RA.SetGroup(SA3);
		...
		//checking the Disposition
		String Actual_Disposition111 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[4]")).getText();
		String Expected_Disposition111 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		System.out.println("Actual Disposition is : " + Actual_Disposition111);
		System.out.println("Expected Disposition is : " + Expected_Disposition111);
		Assert.assertEquals(Actual_Disposition111, Expected_Disposition111, "Disposition is Wrong");
		System.out.println("Disposition is Matched");

		//checking the Compliance Score
		String Actual_ComplianceScore111 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[3]")).getText();
		String Expected_ComplianceScore111 = "No";
		System.out.println("Actual Compliance Score is : " + Actual_ComplianceScore111);
		System.out.println("Expected Compliance Score is : " + Expected_ComplianceScore111);
		Assert.assertEquals(Actual_ComplianceScore111, Expected_ComplianceScore111, "Compliance Score is Wrong");
		System.out.println("Compliance Score is Matched");

		//checking the Submitted Score
		String Actual_SubmittedScore11 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[5]")).getText();
		String Expected_SubmittedScore11 = "";
		...
		String Expected_FinalScore11 = "";
		System.out.println("Final Score is : " + Actual_FinalScore11);
		System.out.println("Final Score is : " + Expected_FinalScore11);
		Assert.assertEquals(Actual_FinalScore11, Expected_FinalScore11, "Final Score is Wrong");
		System.out.println("Final Score is Matched");

		//checking the Input Values
		int Actual_InputValues11 = driver.findElements(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[7]")).size();
		int Expected_InputValues11 = 1;
		Assert.assertEquals(Actual_InputValues11, Expected_InputValues11, "Input Value should be Empty");

		//Checking the Is Issue
		WebElement IsIssue11 = driver.findElement(By.xpath("//table[@id='review_compliance_table']/tbody/tr/td[9]//img"));
		Assert.assertTrue(IsIssue11.isDisplayed(), "Issued Imag is Not Displayed");
		System.out.println("Issue Image Is Displayed");
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "Add CP GP Normal Mode", 93, 0);
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=11, dependsOnMethods= {"Validating_The_Scores_Test"})
	public void Post_Approval_And_Finalization_CP_Should_Reflect_In_Groups_Test() throws InterruptedException
	{
		chiledTest = parentTest.createNode("Post Approval And Finalization CP Should Reflect In Groups Test");

		System.out.println("Post Approval And Finalization CP Should Reflect In Groups Test");
		...
		//Checking total 1 Cp is Displayed
