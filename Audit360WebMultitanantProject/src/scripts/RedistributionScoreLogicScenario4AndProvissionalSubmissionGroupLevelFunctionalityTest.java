...
public class RedistributionScoreLogicScenario4AndProvissionalSubmissionGroupLevelFunctionalityTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Score Logic Scenario 4 And Provissional Submission Group Level Functionality Test", "Testing the Functionality of the Redistribution Score Logic if Group 1 with one NA, Group 2 with all checkpoints NA and Testing the Functionality of the Provissional Submission Audit type which is mapped with Group Level Through Normal ModeTest");

		chiledTest = parentTest.createNode("Creating Group Test");

		System.out.println("***Redistribution Score Logic Scenario 4 Test***");
	   ...
	   /*//clicking on the Group Type
		...
		String ADG = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 21, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 17, 0);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 21, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 21, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 17, 0);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 21, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 17, 0);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 4, 0);
		CC.SetSearchBTN(SS);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 4, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 80, 0);
		...
		String FT = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 9, 0);
	...
	public void Submitting_The_AuditType_Which_Is_Provisionally_Submitted_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 4, 0);
		RA.SetGroup(SA1);
	...
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		chiledTest.log(Status.INFO, "**************Validating 1st Group Score******************");
		...
		String Expected_SubmittedScore = "0.0";
		...
		String Expected_FinalScore = "0.0";
		...
		String Expected_Disposition211 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		...
		String Expected_ComplianceScore211 = "No";
		...
		String Expected_SubmittedScore4 = "0.0";
		...
		String SA2 = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_Disposition2111 = Lib.getCellValue(XLPATH, "Check Point", 155, 0);
		...
		String Expected_ComplianceScore2111 = "No";
		...
		String Expected_TotalScore = "0.0 / 200.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RSL Scenarios 4", 94, 0);
		...
		String Expected_Compliances = "0.0";
		...
		//clicking on the Summary close button
