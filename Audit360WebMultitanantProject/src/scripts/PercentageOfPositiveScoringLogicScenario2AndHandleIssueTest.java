...
public class PercentageOfPositiveScoringLogicScenario2AndHandleIssueTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Percentage Of Positive Score Logic Scenario 2 And Handle Issue Functionality Test", "Testing the Functionality of the Percentage Of Positive Scoring Logic NA Percentage, Actual Audit Score And Handle Issue Functionality test");

		chiledTest = parentTest.createNode("Creating Group Test");

		System.out.println("***Percentage Of Positive Score Logic Scenario 2 Test***");
       ...
       /*//clicking on the Group Type
		...
		String ADG = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to NO Text Box
		String NB5 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB5);

		//Passing Values to NA Text Box
		String NAB = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		CC.SetNATextBox(NAB);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to NO Text Box
		String NB51 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB51);

		//Passing Values to NA Text Box
		String NAB1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to NO Text Box
		String NB7 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB7);

		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 21, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to NO Text Box
		String NB8 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 50, 0);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
		CC.SetNATextBox(NAB3);
		...
		//Passing Values to NA Text Box
		String NAB4 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 17, 0);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 4, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 80, 0);
		...
		chiledTest.log(Status.INFO, "Based On Audit Submission Is Selected under TAT Type");
		...
		String FT = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
	...
	public void SignOff_AuditType_Test() throws InterruptedException
	{
		...
		System.out.println("************Accepting the Issue for the 1st checkpoint******************");

		chiledTest.log(Status.INFO, "************Accepting the Issue for the 1st checkpoint********************");
	...
	//Testing the Functionality of the Finalizing Another Audit Type Test
	@Test(priority=9, dependsOnMethods={"SignOff_AuditType_Test"})
	public void Bulk_Finalize_Should_Not_Be_Allow_For_Audit_Type_Which_has_Issues_Test() throws InterruptedException
	{
		chiledTest = parentTest.createNode("Bulk Finalize Should Not Be Allow For Audit Type Which has Issues Test");

		System.out.println("Bulk Finalize Should Not Be Allow For Audit Type Which has Issues Test");
		...
		//Passing the Values to Select Audit Type 
		String SAT = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
		RA.SetSelectAuditType(SAT, driver);
		chiledTest.log(Status.INFO, "Parent Auidt Type is Searched");

		//Clicking on the Matched Options
		RA.ClickMatchedTextOption(driver);

		RA.ClickGoBTN(driver);

		//Checking Triangle Mark Button is Displayed
		RA.VerifyTriangleButtonIsDisplayed(driver);
	...
	@Test(priority=10, dependsOnMethods= {"Bulk_Finalize_Should_Not_Be_Allow_For_Audit_Type_Which_has_Issues_Test"})
	public void Handling_The_Issue_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 3, 0);
		RA.SetGroup(SA);
		...
		String SA1 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 4, 0);
		RA.SetGroup(SA1);
	...
	//Testing the Functionality of the Creating Parent Audit Type Test
	@Test(priority=11, dependsOnMethods= {"Handling_The_Issue_Test"})
	...
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 92, 0);
		...
		String SA2 = Lib.getCellValue(XLPATH, "POPSL Scenario 2", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_SubmittedScore8 = "25.0";
		...
		String Expected_FinalScore8 = "25.0";
