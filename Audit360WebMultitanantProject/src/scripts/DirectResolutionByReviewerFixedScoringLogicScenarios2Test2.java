...
public class DirectResolutionByReviewerFixedScoringLogicScenarios2Test2 extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Direct Resolution By Reviewer And FXSL Scenario 2 Functionality Test", "Testing the Functionality of the Fixed Score Logic NA Fixed, Actual Audit Score");

		System.out.println("***Direct Resolution By Reviewer And FXSL Scenario 2 Functionality Test***");
		...
		String ADG = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 3, 0);
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 4, 0);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 3, 0);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 22, 0);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 29, 0);
		CC.SetNoTextBox(NB5);

		//Passing Values to NA Text Box
		String NAB = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 41, 0);
		CC.SetNATextBox(NAB);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 29, 0);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 33, 0);
		CC.SetNoTextBox(NB51);

		//Passing Values to NA Text Box
		String NAB1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 41, 0);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 29, 0);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 33, 0);
		CC.SetNoTextBox(NB7);

		//Passing Values to NA Text Box
		String NAB2 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 41, 0);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 29, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 33, 0);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 44, 0);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 4, 0);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to NA Text Box
		String NAB3 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 41, 0);
		CC.SetNATextBox(NAB3);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 22, 0);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 29, 0);
		CC.SetNoTextBox(NB8);

		//Passing Values to NA Text Box
		String NAB4 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 41, 0);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
		...
		String SCG = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 3, 0);
		...
		//Passing the Values to Select CheckPoint 
		String SCG1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 4, 0);
		...
		String LR = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 76, 0);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 67, 0);
		...
		String HR = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 72, 0);
		...
		String ZR = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 80, 0);
		...
		String ST = Lib.getCellValue(XLPATH, "Configure Audit Type", 69, 0);
		CA.SetSelectTATType(ST);
		chiledTest.log(Status.INFO, "Based On Audit Signoff Selected in TAT Type");
		...
		String FT = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 85, 0);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 94, 0);
		...
		String ST1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 86, 0);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 93, 0);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 92, 0);
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
		...
		String MV1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 102, 0);
	...
	public void Signoff_Audit_Test() throws Exception
	{
		...
		chiledTest.log(Status.INFO, "CP2 is Searched");
		...
		//Passing the Cp6 to Search text fields
		String SB1 = Lib.getCellValue(XLPATH, "Check Point", 126, 0);
		MA.SetSearchButton(SB1);
		chiledTest.log(Status.INFO, "CP6 is Searched");
	...
	public void Closing_And_Finalizing_The_AuditType_Test() throws Exception
	{
		chiledTest = parentTest.createNode("Closing And Finalizing Audit Test");

		System.out.println("Closing And Finalizing Audit Test");
		...
		String SB = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 3, 0);
		RA.SetGroup(SA);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 4, 0);
		RA.SetGroup(SA1);
		...
		//passing the Values to Direct Resolution score
		String DRS = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 13, 0);
		RC.SetDirectResolutionScore(DRS);

		//clicking on the Close Button
		RC.ClickCloseButton();

		//checking Resolution is Done message is Displayed
		...
		//passing the Values to Direct Resolution score
		String DRS1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 14, 0);
		...
		//Passing the Values to Search Text field
		String SB1 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 9, 0);
		...
		//Passing the 1st group
		String SA5 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 3, 0);
		RA.SetGroup(SA5);

		RA.ClickMatchedTextOption(driver);

		//Passing the 2nd group
		String SA6 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 4, 0);
		RA.SetGroup(SA6);
	...
	//Testing the Functionality of the Audit Execution page
	@Test(priority=10, dependsOnMethods= {"Closing_And_Finalizing_The_AuditType_Test"})
	public void Validating_The_Scores_Test() throws Exception
	{
		...
		String SA2 = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 4, 0);
		RA.SetGroup(SA2);
		...
		String Expected_TotalScore = "113.25 / 200.0";
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "Direct Res FXSL Scenarios 2", 93, 0);
		...
		String Expected_Compliances = "56.63";
