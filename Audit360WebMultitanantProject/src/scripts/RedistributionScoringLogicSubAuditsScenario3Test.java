...
public class RedistributionScoringLogicSubAuditsScenario3Test extends BaseTest {
	...
	public void Annexure_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Scoring Logic Sub Audits Functionality Scanrio 3 Test", "Scenario-3 NA Re distrubution Logic with all NA in one group");
	...
	public void Adding_Static_Annexure_Test() throws InterruptedException
	{
		...
		String AN = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 0);
	...
	public void Creating_Static_Annexure_Group_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 0);
		...
		String ADG = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 1);
	...
	public void Creating_General_Groups_Test() throws InterruptedException
	{
		...
		String ADG = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 1);
		AG.SetAddnewGroup(ADG);
		chiledTest.log(Status.INFO, "Group Name is Entered");
		...
		//Passing the Values to Add group 
		String ADG1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 1);
	...
	public void Adding_Four_CheckPoints_To_Static_Annexure_Group_Test() throws InterruptedException
	{
		...
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 1);
		CC.SetSearchBTN(SS);
		...
		String YB5 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 7, 4);
		CC.SetYestextBox(YB5);

		//Passing Values to No Text Box
		String NB5 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 5);
		CC.SetNoTextBox(NB5);
		...
		//Passing Values to Yes Text Box
		String YB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 4);
		CC.SetYestextBox(YB51);

		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 6, 5);
		...
		//Passing Values to Yes Text Box
		String YB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 4);
		CC.SetYestextBox(YB7);

		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 5);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 4);
		CC.SetYestextBox(YB8);

		//Passing Values to No Text Box
		String NB8 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 5);
		CC.SetNoTextBox(NB8);
	...
	public void Adding_Four_CheckPoints_To_Group_Test() throws InterruptedException
	{
		...
		CC.ClickManageCheckPointHeader(driver);
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 1);
		CC.SetSearchBTN(SS);
	...
	public void Adding_Four_CheckPoints_To_another_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Search Button
		String SS = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 1);
		CC.SetSearchBTN(SS);
		...
		//Passing Values to Yes Text Box
		String YB5 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 8, 4);
		CC.SetYestextBox(YB5);
		...
		//Passing Values to No Text Box
		String NB51 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 8, 5);
		CC.SetNoTextBox(NB51);
		...
		//Passing Values to No Text Box
		String NB7 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 5);
		CC.SetNoTextBox(NB7);
		...
		//Passing Values to Yes Text Box
		String YB8 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 9, 4);
		CC.SetYestextBox(YB8);
	...
	public void Creating_Sub_AuditTypes_Test() throws InterruptedException
	{
		...
		String ATN2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 2);
		...
		String SCG2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 1);
		...
		//Passing the Values to Audit Type Name
		String ATN4 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 2);
		...
		//Passing the Values to Select CheckPoint Group
		String SCG4 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 1);
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 3);
		...
		//Passing the Values to select Group type
		String SA1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 2);
		...
		//Passing the Values to select Group type
		String SA2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 2);
		...
		//Passing the Values to select Group type
		String SA3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 2);
		...
		String LR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 10);
		CA.SetLowRiskScoring(LR);
		chiledTest.log(Status.INFO, "Low Risk Scoring is Entered");

		//Passing the Values to Medium Risk Scoring
		String MR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 8);
		...
		String HR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 9);
		...
		String ZR = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 11);
		...
		String FT = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 13);
		CA.SetFirstTo(FT, driver);

		//Passing the Values to First Out Come
		String FO = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 14);
		...
		String ST1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 13);
		CA.SetSecondTo(ST1, driver);

		//Passing the Values to Second Out Come
		String SO = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 14);
		CA.SetSecondOutCome(SO, driver);
		chiledTest.log(Status.INFO, "Out Come is Entered");

		//Passing the Values to Third Out Come
		String TO1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 14);
	...
	public void Uploading_Annexure_Documents_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 3);
		UA.SetAuditType(SA);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 3);
	...
	public void Audit_Execution_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 3);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 3);
		...
		String SB11 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 2);
		...
		//Passing the Values to Search Text Filed
		String SB2 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 4, 2);
		AE.SetSearchBTN(SB2);
		...
		//Passing the Values to Search Text Filed
		String SB3 = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 2);
		AE.SetSearchBTN(SB3);
	...
	public void Finalize_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 3);
		...
		String SA = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 5, 2);
		RA.SetSubAudits(SA);
	...
	public void Validating_The_Scores_Test() throws InterruptedException
	{
		...
		String Expected_TotalScore = "137.5 / 150.0"; 
		...
		String Expected_AuditRating = Lib.getCellValue(XLPATH, "RDSL SubAudits Scenario 3", 3, 14);
		...
		String Expected_Compliances = "91.67";
