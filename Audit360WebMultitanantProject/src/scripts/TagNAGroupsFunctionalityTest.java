...
public class TagNAGroupsFunctionalityTest extends BaseTest {
	...
	{
		parentTest = extent.createTest("Tagging NA for Groups Functionality Test", "Testing the Functionality of the Do you want to allow checkpoint group to be skipped during audit execution for this audit at groups level");

		ConfigureAuditPageTest CA = new ConfigureAuditPageTest(driver);

		System.out.println("Tagging NA for Groups Functionality Test");
		...
		String ATN = Lib.getCellValue(XLPATH, "Exceptional Group", 4, 2);
		...
		//enabling the Do you want to allow checkpoint group to be skipped during audit execution for this audit? toggle button
		CA.ClickTagNAToggleBTNToggleBTN();
	...
	public void Auditee_Admin_Configuration_Test() throws InterruptedException
	{
		...
		//passing the values to Select Audit Type
		String SA = Lib.getCellValue(XLPATH, "Exceptional Group", 4, 2);
	...
	public void Creating_Audit_Schedule_Test() throws InterruptedException
	{
		...
		String SAT1 = Lib.getCellValue(XLPATH, "Exceptional Group", 4, 2);
	...
	public void Executing_The_AuditType_Through_Noramal_Mode_Test() throws InterruptedException
	{
		...
		String AT1 = Lib.getCellValue(XLPATH, "Exceptional Group", 4, 2);
		...
		//Passing the General Parent Audit type to Audit Type
		String AT2 = Lib.getCellValue(XLPATH, "Exceptional Group", 4, 2);
		...
		//Checking Express button is disabled
		AE.VerifyExpressButtonIsDisabled();

		//clicking on Normal Mode
		AE.Clicknormal(driver);

		//clicking on the 1st Group Tag NA Button
		AE.Click1stGroupTAGNAButton();

		//clicking on the 2nd Group Tag NA Button
		AE.Click2ndGroupTAGNAButton();

		//checking Sorry, Minimum one group audit has to be executed. Pop up is Displayed
		AE.VerifySorryMinimumOneGroupAuditHasToBeExecutedPOPIsDisplayed();
	...
	@Test(priority=5, dependsOnMethods= {"Executing_The_AuditType_Through_Noramal_Mode_Test"})
	public void Signoffing_The_AuditType_Test() throws InterruptedException
	{
		...
		//checking 1 CP are Displayed
		MA.Verify1CPAreDisplayed();
	...
	public void Finalizing_The_AuditType_Test() throws Exception
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Exceptional Group", 4, 2);
