...
public class RedistributionScoringLogicScenario5AndReorderCheckPointsTest extends BaseTest {
	...
	public void Adding_Group_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Redistribution Score Logic Scenario 5 And Reorder CP Functionality Test", "Testing the Functionality of the Redistribution Score Logic NA with all NO and CP Sequence through Normal Mode");
	...
	public void Creating_Parent_Audit_Type_Test() throws InterruptedException
	{
		...
		//******Passing 2nd Group to Select CheckPoint **********
		...
		//Passing the CP1 to Search text field
		String SB5 = Lib.getCellValue(XLPATH, "Check Point", 125, 0);
		CA.SetDefineTabSearchBTN(SB5);
		chiledTest.log(Status.INFO, "1st CP is Searched");

		//passing the seq to 1st CP
		String CS5 = Lib.getCellValue(XLPATH, "Configure Audit Type", 179, 0);
		CA.SetFirstCPSeq(CS5);
		
		//**************

		//Passing the CP1 to Search text field
		String SB6 = Lib.getCellValue(XLPATH, "Check Point", 126, 0);
		CA.SetDefineTabSearchBTN(SB6);
		chiledTest.log(Status.INFO, "2nd CP is Searched");

		//passing the seq to 2nd CP
		String CS6 = Lib.getCellValue(XLPATH, "Configure Audit Type", 178, 0);
		CA.SetFirstCPSeq(CS6);
		
		//**************

		//Passing the CP3 to Search text field
		String SB7 = Lib.getCellValue(XLPATH, "Check Point", 127, 0);
		CA.SetDefineTabSearchBTN(SB7);
		chiledTest.log(Status.INFO, "3rd CP is Searched");

		//passing the seq to 3rd CP
		String CS7 = Lib.getCellValue(XLPATH, "Configure Audit Type", 177, 0);
		CA.SetFirstCPSeq(CS7);
		
		//*****************

		//Passing the CP4 to Search text field
		String SB8 = Lib.getCellValue(XLPATH, "Check Point", 128, 0);
		CA.SetDefineTabSearchBTN(SB8);
		chiledTest.log(Status.INFO, "4th CP is Searched");

		//passing the seq to 4th CP
		String CS8 = Lib.getCellValue(XLPATH, "Configure Audit Type", 176, 0);
		CA.SetFirstCPSeq(CS8);
	...
	public void Audit_Execution_Tets() throws InterruptedException
	{
		...
		//**********Checking instead of CP1 it should show CP4************
		String CPText1 = Lib.getCellValue(XLPATH, "Check Point", 9, 0);
		...
		//**********Checking instead of CP2 it should show CP3************
		String CPText2 = Lib.getCellValue(XLPATH, "Check Point", 8, 0);
		...
		System.out.println("Displayed CheckPoint Intent Name is : " + CPT2);
		...
		//**********Checking instead of CP3 it should show CP2************
		String CPText3 = Lib.getCellValue(XLPATH, "Check Point", 7, 0);
		...
		//**********Checking instead of CP1 it should show CP4************
		String CPText4 = Lib.getCellValue(XLPATH, "Check Point", 6, 0);
		...
		Assert.assertEquals(CPT4, CPText4);
		...
		//**********Checking instead of CP1 it should show CP4************
		String CPText5 = Lib.getCellValue(XLPATH, "Check Point", 128, 0);
		...
		//Passing the Values to Max values
		String MV7 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		AE.SetMaxValues(MV7, driver);
		chiledTest.log(Status.INFO, "100 is enterd under MAX values");
		...
		String CPText6 = Lib.getCellValue(XLPATH, "Check Point", 127, 0);
		...
		String CPText7 = Lib.getCellValue(XLPATH, "Check Point", 126, 0);
		...
		//Passing the Values to Max values
		String MV6 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
		AE.SetMaxValues(MV6, driver);
		chiledTest.log(Status.INFO, "100 is enterd under MAX values");
		...
		System.out.println("************* Executing 4th CP************");

		//**********Checking instead of CP4 it should show CP1************

		Thread.sleep(5000);

		String CPText8 = Lib.getCellValue(XLPATH, "Check Point", 125, 0);
		...
		//Passing the Values to Max values
		String MV4 = Lib.getCellValue(XLPATH, "RSL Scenarios 5", 102, 0);
