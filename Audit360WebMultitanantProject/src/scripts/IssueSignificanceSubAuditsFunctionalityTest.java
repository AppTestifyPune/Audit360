...
public class IssueSignificanceSubAuditsFunctionalityTest extends BaseTest {
	...
	public void Create_Audit_Type_Page_Test() throws InterruptedException
	{
		...
		parentTest = extent.createTest("Issue Significance With SubAudits Functionality Test", "Testing the Functionality Issue Significance with SubAudits allocation ");
	...
	public void Creating_General_Group_Sub_Audit_Test() throws InterruptedException
	{
		...
		String ATN = Lib.getCellValue(XLPATH, "Issue Significance", 3, 0);
	...
	public void Creating_Annexure_Sub_Audit_Type_For_Dynamic_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
	...
	public void Creating_Annexure_Sub_Audit_Type_For_Static_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
	...
	public void Creating_Parent_Audit_Type_With_One_General_Group_And_Two_Annexue_Group_Test() throws InterruptedException
	{
		...
		//Passing the Values to Audit Type Name
		String ATN = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
		CA.SetAuditTypeName(ATN, driver);
		chiledTest.log(Status.INFO, "Audit Name is Entered");
		...
		//Clicking on the select Group type
		String SA1 = Lib.getCellValue(XLPATH, "Issue Significance", 3, 0);
		...
		//Clicking on the select Group type
		String SA3 = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
		...
		//Clicking on the select Group type
		String SA4 = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
	...
	public void Uploading_Annexure_Documnet_Page_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
		UA.SetAuditType(SA);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
		...
		//Passing the Values to Audit Type
		String SA1 = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
		UA.SetAuditType(SA1);
		chiledTest.log(Status.INFO, "Audit Type is Selected");
	...
	public void Validating_The_Uploaded_Documents_Test() throws InterruptedException
	{
		...
		String SA = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
		...
		//Passing the Values to Sub Audit Type
		String SA1 = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
	...
	public void Creating_Schedule_Test() throws InterruptedException
	{
		...
		String SAT = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
	...
	public void Executing_Audit_Type_Test() throws InterruptedException
	{
		...
		String AT2 = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
		...
		//Passing the Genearl Parent Audit type to Audit Type
		String AT3 = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
		...
		String SB1 = Lib.getCellValue(XLPATH, "Issue Significance", 3, 0); 
		AE.SetSearchBTN(SB1);
		...
		//Passing the Values to Search Text Filed
		String SB11 = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
		...
		//Passing the Values to Search Text Filed
		String SB41 = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
	...
	public void SignOff_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Issue Significance", 3, 0);
		...
		//Passing the Values to search Text Box
		String SB1 = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
		...
		//Passing the Values to search Text Box
		String SB2 = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
	...
	public void Finalize_Audit_Test() throws InterruptedException
	{
		...
		String SB = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
		...
		String SA = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
		RA.SetSubAudits(SA);
		...
		//Passing the Values to Sub Audit under Select Sub audit Type drop down
		String SA1 = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
		RA.SetSubAudits(SA1);
		...
		//Passing the Values to Sub Audit under Select Sub audit Type drop down
		String SA2 = Lib.getCellValue(XLPATH, "Issue Significance", 3, 0);
		RA.SetSubAudits(SA2);
	...
	@Test(priority=14, dependsOnMethods= {"Finalize_Audit_Test"}, enabled=false)  //3088 changes
	public void Issues_Should_Not_Be_Display_For_Reviewer_Test() throws InterruptedException{
		...
		String SPA = Lib.getCellValue(XLPATH, "Issue Significance", 6, 0);
	...
	//Testing Functionality of the Issues Should Not Be Display For Reviewer Test
	@Test(priority=15, dependsOnMethods= {"Issues_Should_Not_Be_Display_For_Reviewer_Test"}, enabled=false) //3088 changes
	...
	@Test(priority=16, dependsOnMethods= {"Finalize_Audit_Test"}) 
	...
	//Testing Search Functionality of the Bulk Resolve Issue
	@Test(priority=17, dependsOnMethods= {"Bulk_Resolve_Issues_By_AuditeeUser_Test"}) 
	public void Closing_And_Reopening_The_Issue_By_Auditor_Test() throws InterruptedException
	{
		...
		int Actual_count = driver.findElements(By.xpath("//table[@id='auditorIssuesTableData']/tbody/tr")).size();
		...
		String SS1 = Lib.getCellValue(XLPATH, "Issue Significance", 3, 0);
		AI.SetSearchBox(SS1);
		...
		RI.VerifyDoYouWantToChooseTheFinalAuditeeRemarksForThisIssue();
		...
		//Searching the Audit Type
		String SS2 = Lib.getCellValue(XLPATH, "Issue Significance", 4, 0);
		AI.SetSearchBox(SS2);
		...
		//Searching the Audit Type
		String SS3 = Lib.getCellValue(XLPATH, "Issue Significance", 5, 0);
		AI.SetSearchBox(SS3);
