...
public class AuditeeRespondentProfilePageFunctionalityTest extends BaseTest{
	...
	public void Profile_Page_Test() throws InterruptedException
	{
		...
		AuditeeRespondentProfilePageTest ARP = new AuditeeRespondentProfilePageTest(driver);

		parentTest = extent.createTest("Auditee Respondent Profile Functionality Test", "Testing the My Profile Page, Edit Profile Test, etc..");
		...
		ARP.VerifyAddOrEditUserPageisDisplayed(driver);
	...
	public void My_Profile_Read_Only_Mode_Fields_Test()
	{
		...
		ARP.VerifyReadOnlyFieldsAreDisplayed();
	...
	public void Update_Profile_Test()
	{
		...
		String FN = Lib.getCellValue(XLPATH, "My Profile", 6, 0);
		ARP.SetFirstName(FN);

		//Passing the Values to Last Name
		String LN = Lib.getCellValue(XLPATH, "My Profile", 6, 1);
		ARP.SetLastName(LN);
		...
		ARP.ClickSubmitBTN(driver);

		//User Updated Successfully Message is Displayed
		ARP.VerifyUserUpdatedSuccessfullyMsgIsDisplayed(driver);
	...
	public void View_Profile_Test() throws InterruptedException
	{
		...
		ARP.VerifyUpdatedDetailsAreDisplayed();
