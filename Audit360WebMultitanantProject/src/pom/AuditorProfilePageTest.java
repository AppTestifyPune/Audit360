...
public class AuditorProfilePageTest extends BaseTest {
	...
	public AuditorProfilePageTest(WebDriver driver)
	{
	...
	public void VerifyUpdatedDetailsAreDisplayed()
	{
		...
		String Expected_FirstName = Lib.getCellValue(XLPATH, "My Profile", 4, 0);
		...
		String Expected_LastName = Lib.getCellValue(XLPATH, "My Profile", 4, 1);
		...
		chiledTest.log(Status.INFO, "Address is Displayed");
