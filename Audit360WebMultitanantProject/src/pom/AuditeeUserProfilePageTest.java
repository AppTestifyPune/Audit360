...
public class AuditeeUserProfilePageTest extends BaseTest{
	...
	public AuditeeUserProfilePageTest(WebDriver driver)
	{
	...
	public void VerifyUpdatedDetailsAreDisplayed()
	{
		...
		String Expected_FirstName = Lib.getCellValue(XLPATH, "My Profile", 5, 0);
