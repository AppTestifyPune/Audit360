...
public class AuditeeReviewerProfilePageTest extends BaseTest {
	...
	public AuditeeReviewerProfilePageTest(WebDriver driver)
	{
	...
	public void VerifyUpdatedDetailsAreDisplayed()
	{
		...
		String Expected_FirstName = Lib.getCellValue(XLPATH, "My Profile", 7, 0);
		...
		String Expected_LastName = Lib.getCellValue(XLPATH, "My Profile", 7, 1);
	...
	public void VerifyReadOnlyFieldsAreDisplayed()
	{
		...
		//Checking the Cluster is Read only or NOT
		WebElement Cluster = driver.findElement(By.xpath("//select[@id='country_clusters' and @disabled='']"));
		Assert.assertTrue(Cluster.isDisplayed(), "Cluster is NOT Read Only Mode");
		System.out.println("Cluster is Read only mode");
		chiledTest.log(Status.INFO, "Cluster is Read only mode");

		//Checking the Auditee is Read only or NOT
		WebElement Auditee = driver.findElement(By.xpath("//select[@id='cluster_auditees' and @disabled='']"));
		Assert.assertTrue(Auditee.isDisplayed(), "Auditee is NOT Read Only Mode");
		System.out.println("Auditee is Read only mode");
		chiledTest.log(Status.INFO, "Auditee is Read only mode");
